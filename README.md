...
1. Use targeted Skills CLI refreshes only, such as `npx skills add supabase/agent-skills -y` or `npx skills add anthonyshew/dotfiles -y`; these update `.agents/skills/*` and `skills-lock.json` for packages tracked by the Skills CLI.
