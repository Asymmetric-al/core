...
test("donor demo login redirects and persists session", async ({ page }) => {
  ...
  test.skip(!roles.donor, "Donor demo account is not configured.");

  const protectedPath = "/donor-dashboard";
