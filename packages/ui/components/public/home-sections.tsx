        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
          <div className="space-y-12">
            <header className="space-y-6">
              ...
              >
                Precision <br />
                <span className="text-slate-500">Philanthropy.</span>
              </h2>
            </header>
            ...
            <div className="absolute z-20 -top-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-slate-100 max-w-[200px] hidden xl:block">
              ...
              <footer className="mt-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[8px] text-slate-600">Field Lead</p>
                </div>
              </footer>
            </div>
          </figure>
    ...
    >
      <div className="container mx-auto px-6">
        <header className="flex flex-col md:flex-row justify-between items-end mb-16 md:mb-24 gap-8 md:gap-12">
          <div className="space-y-6">
            <span className="text-sm font-black text-slate-600 uppercase tracking-[0.4em]">
              Active Deployments
            </span>
            <h2
              id="featured-heading"
