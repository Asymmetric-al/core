...
export type RendererAdapterFailureClass =
  | "invalid_input"
...
/**
 * Candidate-neutral request/result boundary used to compare equivalent product
 * behavior without requiring identical candidate-specific source languages.
 */
export interface RendererAdapterContract {
  ...
  result: {
    ...
    failure: {
      status: "failure";
      classifications: readonly RendererAdapterFailureClass[];
...
export interface RendererQualificationCharterInput {
  ...
  adapter_contract: RendererAdapterContract;
