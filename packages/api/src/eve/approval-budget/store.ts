...
import {
  ...
  EVE_RECORDED_TRUST_ZONES,
  EVE_RECORDED_WRITE_CLASSES,
  EVE_TRUST_ZONES,
  EVE_WRITE_CLASSES,
} from "./types";
...
const decisionSchema = z.object({
  ...
  action_id: z.string(),
  target_key: z.string(),
  trust_zone: z.enum(EVE_RECORDED_TRUST_ZONES),
  write_class: z.enum(EVE_RECORDED_WRITE_CLASSES),
