...
function StatusSelectField({ control }: { control: Control<TaskFormValues> }) {
  return (
    <FormField
      control={control}
      name="status"
...
function TaskNotesField({ control }: { control: Control<TaskFormValues> }) {
  return (
    <FormField
      control={control}
      name="notes"
            ...
            <Form {...form}>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <TaskTypeSelectField control={form.control} />
                  <PrioritySelectField control={form.control} />
                </div>
                ...
                <StatusSelectField control={form.control} />
