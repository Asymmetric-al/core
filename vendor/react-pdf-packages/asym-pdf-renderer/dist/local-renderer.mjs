import { DocumentPageSettingsSchema } from "@asym/pdf-template-schema";
...
//#endregion
export { isPlaywrightBrowserUnavailable, localRendererBoundary, renderPlaywrightLocalPdf };

//# sourceMappingURL=local-renderer.mjs.map