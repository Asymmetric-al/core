...
source_path: skills/mobile-native/
...
# Upstream: mobile-native

Canonical copy in this repo: `docs/ai/skills/mobile-native/`, mirrored to
...
- Content between `<!-- CORE-OVERLAY-START -->` and
  ...
  refresh command.
- `docs/ai/rules/frontend.md`, Base UI / `base-maia`, `emil-design-engineering`,
  and `anim` remain higher-priority implementation guidance.
- Unused for ordinary Core frontend work. Keep it explicit-only for requested
  mobile-web native-feel, viewport, touch, or safe-area work. Keep
