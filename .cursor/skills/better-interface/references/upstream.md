...
source_path: skills/better-interface/
...
# Upstream: better-interface

Canonical copy in this repo: `docs/ai/skills/better-interface/`, mirrored to
...
1. Refresh the lockfile-managed skill with a targeted Skills CLI add:
   `npx skills add jakubkrehel/skills --skill better-interface -y`.
