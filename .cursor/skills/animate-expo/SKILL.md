...
This skill is for React Native / Expo motion only. Core's Next.js apps should
use `animate`, `emil-design-engineering`, and `anim` instead. Reconcile this
...
- Do not load it for Core web apps (`apps/admin`, `apps/donor`,
  `apps/missionary`) or shared `packages/ui` web motion.
