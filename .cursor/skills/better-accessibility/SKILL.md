...
This is a companion checklist. Core's accessibility owner is
`docs/ai/skills/accessibility-review/SKILL.md`, subordinate to
`docs/ai/rules/frontend.md` and `docs/ai/rules/testing.md`.
...
- Additional a11y heuristics while implementing or reviewing UI.
- Do not replace `accessibility-review` or skip axe/manual verification.

### Workflow

1. Load `docs/ai/skills/accessibility-review/SKILL.md` first.
2. Keep Base UI semantics and `base-maia` focus/contrast patterns.
3. Use Core testing rules for axe and keyboard evidence.

### Checklist

- [ ] `accessibility-review` remained the Core a11y owner.
- [ ] Upstream examples did not weaken Base UI or reduced-motion baselines.
