---
name: repo-entry
description: "Load at the start of work in this monorepo. Pointer to AGENTS.md, canonical skills under docs/ai/skills/, and the skills:sync / skills:verify workflow for mirror directories."
metadata:
  owner: core
...
- You are new to the repo or resuming work and need the authoritative map of rules and skills.
...
4. Optional extra packs may exist only under **`.cursor/skills/`**; use them when their `SKILL.md` description matches the task.
