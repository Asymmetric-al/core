...
operational identity, relationships, and permissions-sensitive records
behind Asym-owned server boundaries. Twenty is the current backing
implementation and stays an internal subsystem; Mission Control remains the
native staff CRM experience, and sync, identity linkage, and cutover stay
durable, auditable, and reversible.
