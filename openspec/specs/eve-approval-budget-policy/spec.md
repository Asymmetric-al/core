# eve-approval-budget-policy Specification

## Purpose

Define the non-bypassable trust-zone, write-class, hard-budget, approval, and
bounded emergency-override policy consumed before any governed Eve effect.
