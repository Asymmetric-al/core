# eve-subagent-catalog-shared-run-context Specification

## Purpose

Define Eve's initial declared specialist catalog, bounded delegation policy,
and tenant-scoped shared run context with complete attribution, sensitive-data
exclusion, preserved disagreement, and governed append-only resolution.
