# eve-sandbox-engineering-worker Specification

## Purpose

Define the isolation, sensitive-data exclusion, audit, approval, and
app-owned network-control requirements for Eve's writable engineering
sandbox.
...
- GIVEN the sandbox is provisioned in an isolated verification environment
