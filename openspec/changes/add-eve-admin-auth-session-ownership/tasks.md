...
## 2. Record the provisional Eve design decision EVE-DESIGN-0008 (admin auth and session ownership)

- [ ] 2.1 Author the decision under provisional Eve design label EVE-DESIGN-0008 in this change's `design.md`, traceable from #422 (admin memory), EVE-DESIGN-0005 (#423),
      and EVE-DESIGN-0007 (#425)
...
- [ ] 2.3 Cross-link the resulting canonical ADR from the parent PRD and issue #426
