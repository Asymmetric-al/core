...
console.
**Migration**: Use **Mission Control As The Staff Operations Surface** as the
...
more clearly.
**Migration**: Use **Missionary Workspace As The Missionary Support-Raising
Surface** as the authoritative statement of what the missionary workspace is and
is not for.
...
**Migration**: Use **Donor Portal As The Donor Self-Service Surface**,
**Public Tenant Website As The Public Ministry Surface**, and
...
**Cross-Surface Continuous Flows**, and **Coherence, Visibility, And Simplicity
