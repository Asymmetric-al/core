...
## 2. Record ADR-0011 (sandbox engineering worker)

- [ ] 2.1 Author ADR-0011 in this change's `design.md`, traceable from ADR-0004 (#420), ADR-0005 (#423), and
      ADR-0007 (#425)
- [ ] 2.2 Land the ADR at the repo's chosen ADR location (confirm convention with maintainers, same as ADR-0001)
- [ ] 2.3 Cross-link ADR-0011 from the parent PRD and issue #429
