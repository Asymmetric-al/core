...
The system SHALL support the following observable outcome for the account holder: a useful self-service Home with recognizable ordinary destinations, so that I can complete my task without a tour or staff detour. The exact shared and domain contract sections EX01, EX06, EX15 define the applicable source and scope limits.

#### Scenario: US25-U01 independently verifiable outcome
...
The system SHALL support the following observable outcome for the person who helps manage an organization's giving: the correct financial context without changing my personal reading or contact choices, so that I know whose records and choices I am acting on. The exact shared and domain contract sections EX01, EX05, EX07, EX09, EX14 define the applicable source and scope limits.

#### Scenario: US25-U02 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor using an older bookmark: recurring-giving links to retain their meaning while fixed-total pledges have a distinct destination, so that I never enter the wrong commitment product. The exact shared and domain contract sections EX01, EX02 define the applicable source and scope limits.

#### Scenario: US25-U03 independently verifiable outcome
...
The system SHALL support the following observable outcome for the recipient of an organization-shared Updates link: to open my own permitted Updates, so that a forwarded link is useful without exposing its sender's feed. The exact shared and domain contract sections EX02, EX03 define the applicable source and scope limits.

#### Scenario: US25-U04 independently verifiable outcome
...
The system SHALL support the following observable outcome for the signed-out reader: to sign in and continue to the exact task I opened, so that authentication does not lose my place. The exact shared and domain contract sections EX01, EX02 define the applicable source and scope limits.

#### Scenario: US25-U05 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader sharing or opening content: honest safe links and copy feedback, so that I do not accidentally share protected information or assume copying succeeded. The exact shared and domain contract sections EX02, EX14, EX15 define the applicable source and scope limits.

#### Scenario: US25-U06 independently verifiable outcome
...
The system SHALL support the following observable outcome for the account holder without available financial records: a calm welcome and useful connection to ministry content, so that an empty account feels usable without invented giving. The exact shared and domain contract sections EX06, EX14 define the applicable source and scope limits.

#### Scenario: US25-U07 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor browsing Home: a short readable Ministry Updates preview, so that I can keep connected without an endless feed. The exact shared and domain contract sections EX03, EX06, EX15 define the applicable source and scope limits.

#### Scenario: US25-U08 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader whose Updates are empty or hidden: one truthful local explanation and permitted management, so that I can recover my view without exposing or restoring hidden content. The exact shared and domain contract sections EX03, EX04, EX06, EX14 define the applicable source and scope limits.

#### Scenario: US25-U09 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor returning after activity or a slow request: the same stable Home with current truthful results, so that I can continue without losing place or repeating a gift. The exact shared and domain contract sections EX06, EX07, EX14 define the applicable source and scope limits.

#### Scenario: US25-U10 independently verifiable outcome
...
The system SHALL support the following observable outcome for the Ministry Updates reader: one combined list of my permitted posts, so that I can begin reading without first choosing a ministry. The exact shared and domain contract sections EX03, EX04 define the applicable source and scope limits.

#### Scenario: US25-U11 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader looking for one ministry: a safe source filter that covers the actual reading set, so that I can find relevant posts even when they are not on the first loaded page. The exact shared and domain contract sections EX03, EX14 define the applicable source and scope limits.

#### Scenario: US25-U12 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader changing a filter: a clear stable transition to the chosen view, so that I do not see another view's late results. The exact shared and domain contract sections EX03, EX15 define the applicable source and scope limits.

#### Scenario: US25-U13 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader with many posts: complete deliberate continuation and a recoverable reading position, so that I can reach every permitted result without duplicates or false endings. The exact shared and domain contract sections EX03, EX14 define the applicable source and scope limits.

#### Scenario: US25-U14 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader during new publication or access change: stable reading that immediately respects current safety, so that new posts do not interrupt me and withdrawn data does not return. The exact shared and domain contract sections EX03, EX14 define the applicable source and scope limits.

#### Scenario: US25-U15 independently verifiable outcome
...
The system SHALL support the following observable outcome for the person who hid a ministry: to open a deliberate exact post while retaining my ordinary Hide choice, so that I can read a specific link without changing my preferences. The exact shared and domain contract sections EX02, EX03, EX04 define the applicable source and scope limits.

#### Scenario: US25-U16 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader of private content: only authorized safe text and media with useful local failures, so that protected material cannot leak through alternate copies. The exact shared and domain contract sections EX03, EX14 define the applicable source and scope limits.

#### Scenario: US25-U17 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader using an available reaction or comment: the same durable allowed response across surfaces, so that I can trust the result after returning. The exact shared and domain contract sections EX03, EX14, EX16 define the applicable source and scope limits.

#### Scenario: US25-U18 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader: to hide or show one ministry's posts, so that I control my ordinary reading without other changes. The exact shared and domain contract sections EX04, EX05 define the applicable source and scope limits.

#### Scenario: US25-U19 independently verifiable outcome
...
The system SHALL support the following observable outcome for the recipient: to choose eligible post emails independently of reading, so that I can receive either, both or neither. The exact shared and domain contract sections EX04, EX05 define the applicable source and scope limits.

#### Scenario: US25-U20 independently verifiable outcome
...
The system SHALL support the following observable outcome for the person editing preferences: each control to save only its intended value, so that one failure cannot erase another successful choice. The exact shared and domain contract sections EX04, EX05, EX14 define the applicable source and scope limits.

#### Scenario: US25-U21 independently verifiable outcome
...
The system SHALL support the following observable outcome for the recipient withdrawing post emails: Off to remain effective even after an earlier uncertain On, so that reconnects and delayed work cannot silently opt me back in. The exact shared and domain contract sections EX04, EX05, EX14 define the applicable source and scope limits.

#### Scenario: US25-U22 independently verifiable outcome
...
The system SHALL support the following observable outcome for the person whose preference response was lost: to reconcile the same operation and current state, so that I do not undo a successful save or repeat a changed instruction. The exact shared and domain contract sections EX04, EX05, EX14 define the applicable source and scope limits.

#### Scenario: US25-U23 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader managing hidden sources: a discoverable safe management path with both controls, so that hiding content never traps me out of email or restoration settings. The exact shared and domain contract sections EX04, EX05, EX15 define the applicable source and scope limits.

#### Scenario: US25-U24 independently verifiable outcome
...
The system SHALL support the following observable outcome for the account holder opening Preferences: a useful current overview with simple direct choices, so that I can understand my settings before entering detail. The exact shared and domain contract sections EX05, EX15 define the applicable source and scope limits.

#### Scenario: US25-U25 independently verifiable outcome
...
The system SHALL support the following observable outcome for the account holder with many topics or ministries: complete qualitative summaries and focused management, so that a large set remains understandable without misleading counts. The exact shared and domain contract sections EX05, EX14 define the applicable source and scope limits.

#### Scenario: US25-U26 independently verifiable outcome
...
The system SHALL support the following observable outcome for the person editing a focused preference: a direct contextual journey and predictable Back, so that I need no extra category or save ceremony. The exact shared and domain contract sections EX02, EX05, EX15 define the applicable source and scope limits.

#### Scenario: US25-U27 independently verifiable outcome
...
The system SHALL support the following observable outcome for the recipient facing an unavailable or ineligible choice: a truthful state and the appropriate existing next step, so that I do not mistake a disabled capability for an opt-out. The exact shared and domain contract sections EX04, EX05 define the applicable source and scope limits.

#### Scenario: US25-U28 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with a current required step: one clear Needs attention section, so that I can find what actually needs my action. The exact shared and domain contract sections EX07 define the applicable source and scope limits.

#### Scenario: US25-U29 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor scanning current needs: recognizable scoped context and one useful next link, so that I can choose an action confidently. The exact shared and domain contract sections EX01, EX02, EX07 define the applicable source and scope limits.

#### Scenario: US25-U30 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with multiple needs: a compact stable preview with complete further access, so that important work is visible without an alert wall. The exact shared and domain contract sections EX07, EX15 define the applicable source and scope limits.

#### Scenario: US25-U31 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor returning to a need after delay or partial outage: current source truth without repeating completed work, so that I can recover safely and still use other portal areas. The exact shared and domain contract sections EX07, EX09, EX14 define the applicable source and scope limits.

#### Scenario: US25-U32 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor receiving notifications: only meaningful qualified notices, so that the bell is useful without every payment, post or email becoming noise. The exact shared and domain contract sections EX08, EX16 define the applicable source and scope limits.

#### Scenario: US25-U33 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor opening the bell: a small All-first view with clear current actions and recent information, so that I can find a relevant notice without managing an inbox. The exact shared and domain contract sections EX09, EX15 define the applicable source and scope limits.

#### Scenario: US25-U34 independently verifiable outcome
...
The system SHALL support the following observable outcome for the human who shares responsibility for giving: my own scoped notification and read state, so that another representative cannot read or clear notices for me. The exact shared and domain contract sections EX09, EX14 define the applicable source and scope limits.

#### Scenario: US25-U35 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor reading a notification: reading to clear only unread treatment, so that I do not accidentally resolve or execute the underlying task. The exact shared and domain contract sections EX08, EX09 define the applicable source and scope limits.

#### Scenario: US25-U36 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor organizing an informational notice: safe limited Archive and Restore, so that I can tidy a view without hiding required work or reviving expired access. The exact shared and domain contract sections EX09 define the applicable source and scope limits.

#### Scenario: US25-U37 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor marking current notifications read: a precise bounded scope that excludes later arrivals, so that new meaningful information remains discoverable. The exact shared and domain contract sections EX09, EX14 define the applicable source and scope limits.

#### Scenario: US25-U38 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor returning after time has passed: notification history to respect its actual source lifetime, so that old messages do not become new obligations. The exact shared and domain contract sections EX09, EX13 define the applicable source and scope limits.

#### Scenario: US25-U39 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor encountering a notice outage or stale link: safe local recovery to current source information, so that a broken notification does not break the task or expose old data. The exact shared and domain contract sections EX09, EX14, EX16 define the applicable source and scope limits.

#### Scenario: US25-U40 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor exploring one ministry: an optional direct full-page overview of that exact context, so that I can read and manage relevant records without a directory detour. The exact shared and domain contract sections EX02, EX10 define the applicable source and scope limits.

#### Scenario: US25-U41 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor using ministry context after a fund change: the actual current fund scope with older records preserved, so that I am not misled into believing older giving moved. The exact shared and domain contract sections EX10, EX14 define the applicable source and scope limits.

#### Scenario: US25-U42 independently verifiable outcome
...
The system SHALL support the following observable outcome for the reader on a ministry overview: small independently permitted sections in useful order, so that the page works with partial rights and on a phone. The exact shared and domain contract sections EX10, EX15 define the applicable source and scope limits.

#### Scenario: US25-U43 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor reviewing a ministry's recurring records: only exact matching line facts and honest further links, so that a shared arrangement cannot misstate my support for this fund. The exact shared and domain contract sections EX10 define the applicable source and scope limits.

#### Scenario: US25-U44 independently verifiable outcome
...
The system SHALL support the following observable outcome for the person leaving and returning to a ministry overview: my authorized task and position to survive change, so that I can resume without seeing stale or unrelated records. The exact shared and domain contract sections EX02, EX10, EX14 define the applicable source and scope limits.

#### Scenario: US25-U45 independently verifiable outcome
...
The system SHALL support the following observable outcome for the guest interested in a missionary newsletter: one short request without signing up or checking my inbox, so that I can express interest with minimal effort. The exact shared and domain contract sections EX11 define the applicable source and scope limits.

#### Scenario: US25-U46 independently verifiable outcome
...
The system SHALL support the following observable outcome for the signed-in newsletter requester: editable human prefills that stay private and affect only the request, so that convenience does not change my account or leak to another visitor. The exact shared and domain contract sections EX11, EX14 define the applicable source and scope limits.

#### Scenario: US25-U47 independently verifiable outcome
...
The system SHALL support the following observable outcome for the newsletter requester entering international data: a usable single-column form with honest rejection and no-JS support, so that I can submit without unnecessary format barriers. The exact shared and domain contract sections EX11, EX13, EX15 define the applicable source and scope limits.

#### Scenario: US25-U48 independently verifiable outcome
...
The system SHALL support the following observable outcome for the newsletter requester after submitting: a durable Request received result and simple return, so that I know my request was recorded without a false delivery promise. The exact shared and domain contract sections EX11, EX12 define the applicable source and scope limits.

#### Scenario: US25-U49 independently verifiable outcome
...
The system SHALL support the following observable outcome for the newsletter requester with a lost response or double click: safe same-request reconciliation, so that uncertainty does not send the missionary duplicate requests. The exact shared and domain contract sections EX11, EX12, EX14 define the applicable source and scope limits.

#### Scenario: US25-U50 independently verifiable outcome
...
The system SHALL support the following observable outcome for the newsletter requester who notices a submitted typo: an honest way to send corrected details, so that I can fix my request without believing the first handoff was recalled. The exact shared and domain contract sections EX11 define the applicable source and scope limits.

#### Scenario: US25-U51 independently verifiable outcome
...
The system SHALL support the following observable outcome for the missionary receiving newsletter interest: a concise actionable governed email with truthful proof wording, so that I can handle the request through my usual external process. The exact shared and domain contract sections EX12 define the applicable source and scope limits.

#### Scenario: US25-U52 independently verifiable outcome
...
The system SHALL support the following observable outcome for the missionary checking a dashboard request: the same bounded request under my current exact authority, so that I can use the address without a duplicate workflow or data leak. The exact shared and domain contract sections EX12, EX13 define the applicable source and scope limits.

#### Scenario: US25-U53 independently verifiable outcome
...
The system SHALL support the following observable outcome for the operator supporting a newsletter handoff: independent durable outcomes and exact current recipient fences, so that one failed channel can recover without repeating success or leaking to a successor. The exact shared and domain contract sections EX12, EX14 define the applicable source and scope limits.

#### Scenario: US25-U54 independently verifiable outcome
...
The system SHALL support the following observable outcome for the newsletter requester or missionary: old request data and late work to expire at the declared limits, so that an old request cannot reappear as new or expose contact details indefinitely. The exact shared and domain contract sections EX13 define the applicable source and scope limits.

#### Scenario: US25-U55 independently verifiable outcome
...
The system SHALL support the following observable outcome for the legitimate guest sharing a network with other visitors: proportionate bounded request protection, so that abuse controls do not turn every ordinary request into a verification workflow. The exact shared and domain contract sections EX13, EX16 define the applicable source and scope limits.

#### Scenario: US25-U56 independently verifiable outcome
...
The system SHALL support the following observable outcome for the person using keyboard, assistive technology, zoom or a phone: the same complete readable and operable journeys, so that I can finish tasks without hidden labels, focus traps or clipped consequences. The exact shared and domain contract sections EX15, EX16 define the applicable source and scope limits.

#### Scenario: US25-U57 independently verifiable outcome
...
The system SHALL support the following observable outcome for the account holder whose session or rights change: private state and all alternate access paths to respect the current boundary, so that old caches or direct URLs cannot expose another person's data. The exact shared and domain contract sections EX14 define the applicable source and scope limits.

#### Scenario: US25-U58 independently verifiable outcome
...
The system SHALL support the following observable outcome for the maintainer operating these donor services: minimal useful source-owned diagnostics and bounded monitoring, so that I can recover real failures without surveilling donors or inventing tasks. The exact shared and domain contract sections EX14, EX17 define the applicable source and scope limits.

#### Scenario: US25-U59 independently verifiable outcome
...
The system SHALL support the following observable outcome for the release owner: one qualified owner path and honest complete-journey evidence, so that a polished screen cannot hide unsafe or unimplemented behavior. The exact shared and domain contract sections EX16 define the applicable source and scope limits.

#### Scenario: US25-U60 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: open my own giving immediately on a neutral visit, so that ordinary personal tasks need no account chooser. The exact shared and domain contract sections IC02 define the applicable source and scope limits.

#### Scenario: US25-I01 independently verifiable outcome
...
The system SHALL support the following observable outcome for the representative-only donor: enter the giving I am permitted to manage without creating a personal gift record, so that I can complete legitimate work with my existing access. The exact shared and domain contract sections IC02 define the applicable source and scope limits.

#### Scenario: US25-I02 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor representative: see whose giving I am viewing while my login remains mine, so that I do not confuse representation with impersonation. The exact shared and domain contract sections IC01, IC02 define the applicable source and scope limits.

#### Scenario: US25-I03 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: switch giving contexts without retargeting work or preferences, so that my accepted instructions and private information stay correctly scoped. The exact shared and domain contract sections IC02, IC15 define the applicable source and scope limits.

#### Scenario: US25-I04 independently verifiable outcome
...
The system SHALL support the following observable outcome for the authorized nonfinancial portal user: reach my admitted reading or document task without a financial donor gate, so that legitimate access does not depend on having donated. The exact shared and domain contract sections IC02 define the applicable source and scope limits.

#### Scenario: US25-I05 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: use email first and clearly labelled qualified social alternatives, so that sign-in remains familiar and understandable. The exact shared and domain contract sections IC03, IC05, IC15 define the applicable source and scope limits.

#### Scenario: US25-I06 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: choose the link or code in the first sign-in email, so that I can sign in on the device that is convenient. The exact shared and domain contract sections IC03 define the applicable source and scope limits.

#### Scenario: US25-I07 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: have email previews and scanners leave my sign-in proof untouched, so that opening or checking a message cannot authenticate or mutate my account. The exact shared and domain contract sections IC03 define the applicable source and scope limits.

#### Scenario: US25-I08 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: recover from expired codes, resends, denied provider consent and lost responses, so that I can finish without repeated messages or duplicate accounts. The exact shared and domain contract sections IC03, IC05, IC15 define the applicable source and scope limits.

#### Scenario: US25-I09 independently verifiable outcome
...
The system SHALL support the following observable outcome for the account holder: have a new social identity prove the required native trust before joining my account, so that a stale or misleading email assertion cannot acquire my credentials. The exact shared and domain contract sections IC04, IC16 define the applicable source and scope limits.

#### Scenario: US25-I10 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: have provider identity and email treated according to their actual evidence, so that my account and giving are not inferred from mutable metadata. The exact shared and domain contract sections IC01, IC04, IC05 define the applicable source and scope limits.

#### Scenario: US25-I11 independently verifiable outcome
...
The system SHALL support the following observable outcome for the account holder: connect or disconnect a sign-in method deliberately, so that I keep the correct account and a usable recovery route. The exact shared and domain contract sections IC05, IC08 define the applicable source and scope limits.

#### Scenario: US25-I12 independently verifiable outcome
...
The system SHALL support the following observable outcome for the Apple sign-in user: use relay privacy and recover when my Apple account changes, so that convenience does not disclose my underlying mailbox or strand access. The exact shared and domain contract sections IC05, IC16 define the applicable source and scope limits.

#### Scenario: US25-I13 independently verifiable outcome
...
The system SHALL support the following observable outcome for the Facebook sign-in user: use a publicly qualified login and receive a clear fallback when email is unavailable, so that a development-only success does not become a broken donor experience. The exact shared and domain contract sections IC05, IC16 define the applicable source and scope limits.

#### Scenario: US25-I14 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: understand the organization's brand and the external provider handoff, so that I know which service is authenticating me. The exact shared and domain contract sections IC02, IC05 define the applicable source and scope limits.

#### Scenario: US25-I15 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor changing email: enter one new address and explicitly select the uses I want to change, so that I avoid repeated effort without updating unrelated contact records. The exact shared and domain contract sections IC06 define the applicable source and scope limits.

#### Scenario: US25-I16 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor changing email: complete the necessary mailbox proofs without redundant challenges, so that my change is secure and understandable. The exact shared and domain contract sections IC06, IC07 define the applicable source and scope limits.

#### Scenario: US25-I17 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor changing both email uses: see each real result and resume only unfinished work, so that a partial failure does not undo or repeat a successful change. The exact shared and domain contract sections IC07, IC08, IC09 define the applicable source and scope limits.

#### Scenario: US25-I18 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor changing email: leave, correct or recover a pending request truthfully, so that I do not accidentally cancel or revive an old proof. The exact shared and domain contract sections IC07 define the applicable source and scope limits.

#### Scenario: US25-I19 independently verifiable outcome
...
The system SHALL support the following observable outcome for the established donor: keep my verified claim when I change a contact address, so that mutable contact data does not erase or transfer my history. The exact shared and domain contract sections IC01, IC06 define the applicable source and scope limits.

#### Scenario: US25-I20 independently verifiable outcome
...
The system SHALL support the following observable outcome for the account holder across organizations: have shared credential changes reconcile current access everywhere they apply, so that old sensitive authority cannot survive an identity transition. The exact shared and domain contract sections IC02, IC08 define the applicable source and scope limits.

#### Scenario: US25-I21 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor finishing email verification: keep the exact completing device signed in while other old sessions are retired, so that I can continue safely without an inaccurate session promise. The exact shared and domain contract sections IC08 define the applicable source and scope limits.

#### Scenario: US25-I22 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor changing contact email: retain my authored communication choices and receive only the required qualified messages, so that a contact edit does not enroll me or redirect old mail. The exact shared and domain contract sections IC09 define the applicable source and scope limits.

#### Scenario: US25-I23 independently verifiable outcome
...
The system SHALL support the following observable outcome for the authenticated account holder: receive a truthful address-unavailable result without disclosure of another donor, so that the system does not claim an assurance its provider cannot supply. The exact shared and domain contract sections IC09 define the applicable source and scope limits.

#### Scenario: US25-I24 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: update the name used for this organization's ordinary contact without a surname requirement, so that my actual name survives the system's formatting assumptions. The exact shared and domain contract sections IC10 define the applicable source and scope limits.

#### Scenario: US25-I25 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: keep or clear an optional usable contact phone, so that contact information does not become an authentication or consent change. The exact shared and domain contract sections IC10, IC15 define the applicable source and scope limits.

#### Scenario: US25-I26 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor updating personal contact: receive one durable result through every supported editor or API, so that a partial write or alternate route cannot contradict my change. The exact shared and domain contract sections IC10, IC16 define the applicable source and scope limits.

#### Scenario: US25-I27 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: see one optional current mailing address with only permitted actions, so that postal contact remains a simple occasional task. The exact shared and domain contract sections IC11 define the applicable source and scope limits.

#### Scenario: US25-I28 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor editing postal contact: use one clear inline form that preserves my address and place in the page, so that I can make a routine update without a wizard or verification trip. The exact shared and domain contract sections IC11, IC15 define the applicable source and scope limits.

#### Scenario: US25-I29 independently verifiable outcome
...
The system SHALL support the following observable outcome for the international donor: enter my address as appropriate structured fields or ordered postal lines, so that the software does not discard units or invent a domestic format. The exact shared and domain contract sections IC11 define the applicable source and scope limits.

#### Scenario: US25-I30 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor or authorized staff member: save a mailing change against its exact current revision, so that concurrent changes and retries cannot overwrite one another. The exact shared and domain contract sections IC12 define the applicable source and scope limits.

#### Scenario: US25-I31 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor who moves: withdraw old personal-mailing use including formatting predecessors, so that mail cannot use an old residence merely because it referenced an earlier format. The exact shared and domain contract sections IC12, IC13 define the applicable source and scope limits.

#### Scenario: US25-I32 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with mail being prepared: understand the separate result for saved address and existing mail, so that the portal does not promise recall or silently start another delivery. The exact shared and domain contract sections IC13 define the applicable source and scope limits.

#### Scenario: US25-I33 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: remove my current mailing address deliberately, so that I can stop that current use without changing giving or erasing required records. The exact shared and domain contract sections IC12, IC13 define the applicable source and scope limits.

#### Scenario: US25-I34 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: have retired postal values and diagnostic copies kept only for their declared purposes, so that a simple move does not create an indefinite address trail. The exact shared and domain contract sections IC14 define the applicable source and scope limits.

#### Scenario: US25-I35 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: have same-account context and security changes remove stale private data, so that late requests cannot expose an old address or another giving context. The exact shared and domain contract sections IC15 define the applicable source and scope limits.

#### Scenario: US25-I36 independently verifiable outcome
...
The system SHALL support the following observable outcome for the authorized support operator: diagnose the exact identity or contact stage with safe evidence, so that I can recover work without raw credential handling or invented authority. The exact shared and domain contract sections IC07, IC09, IC15 define the applicable source and scope limits.

#### Scenario: US25-I37 independently verifiable outcome
...
The system SHALL support the following observable outcome for the release reviewer: verify complete identity/contact journeys at their real boundaries, so that green mocks cannot certify unsafe account or mailing behavior. The exact shared and domain contract sections IC16 define the applicable source and scope limits.

#### Scenario: US25-I38 independently verifiable outcome
...
The system SHALL support the following observable outcome for the implementation owner: adopt one source of truth while preserving accepted work and history, so that mixed versions and rollback do not restore old unsafe behavior. The exact shared and domain contract sections IC01, IC16 define the applicable source and scope limits.

#### Scenario: US25-I39 independently verifiable outcome
...
The system SHALL support the following observable outcome for the platform or CRM operations owner: operate bounded identity and mailing work with explicit signals and responses, so that saturation or configuration drift is diagnosed without weakening safety. The exact shared and domain contract sections IC05, IC14, IC16 define the applicable source and scope limits.

#### Scenario: US25-I40 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: open current recurring giving with obvious access to past arrangements, so that I can manage present giving and find history without another chooser. The exact shared and domain contract sections RC03, RC04 define the applicable source and scope limits.

#### Scenario: US25-R01 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with limited line access: see each real arrangement classified from the lines I may access, so that hidden siblings neither leak information nor hide my past giving. The exact shared and domain contract sections RC02, RC03 define the applicable source and scope limits.

#### Scenario: US25-R02 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: understand paused, processing and terminal-but-unresolved giving, so that I know whether future intent or payment confirmation still needs attention. The exact shared and domain contract sections RC01, RC03, RC19, RC20 define the applicable source and scope limits.

#### Scenario: US25-R03 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: search my current or past recurring gifts and open exact details, so that I can find older or less visible gifts without changing financial scope. The exact shared and domain contract sections RC03, RC04 define the applicable source and scope limits.

#### Scenario: US25-R04 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with several gifts in an arrangement: read a compact preview and reach every permitted line, so that the group stays recognizable without hiding important consequences. The exact shared and domain contract sections RC04 define the applicable source and scope limits.

#### Scenario: US25-R05 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with a long recurring history: continue through all admitted arrangements and large groups, so that page and rendering limits do not silently lose records. The exact shared and domain contract sections RC04, RC26, RC27 define the applicable source and scope limits.

#### Scenario: US25-R06 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: see exact money, cadence and calendar facts, so that I do not agree to an invented amount or date. The exact shared and domain contract sections RC05 define the applicable source and scope limits.

#### Scenario: US25-R07 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: edit relevant recurring terms in one focused workspace, so that I can make a simple or combined change without a wizard. The exact shared and domain contract sections RC06 define the applicable source and scope limits.

#### Scenario: US25-R08 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: collapse sections or undo one edit without losing other work, so that the visible controls mean what they say. The exact shared and domain contract sections RC06 define the applicable source and scope limits.

#### Scenario: US25-R09 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: receive linked validation for the whole proposal, so that hidden or dependent errors cannot cause a wrong financial change. The exact shared and domain contract sections RC05, RC06 define the applicable source and scope limits.

#### Scenario: US25-R10 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor or authorized representative: review the full combined exposure of my requested changes, so that a reduction in one field does not hide a wider instruction elsewhere. The exact shared and domain contract sections RC02, RC06, RC07 define the applicable source and scope limits.

#### Scenario: US25-R11 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: change my continuing date or optional end with clear calendar consequences, so that I know which future gifts move or stop. The exact shared and domain contract sections RC05, RC06 define the applicable source and scope limits.

#### Scenario: US25-R12 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: check every material consequence before accepting a recurring change, so that my consent matches the actual effect. The exact shared and domain contract sections RC07 define the applicable source and scope limits.

#### Scenario: US25-R13 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: return from secure setup or authentication to the right stage, so that a provider callback is not mistaken for a completed recurring change. The exact shared and domain contract sections RC07, RC08 define the applicable source and scope limits.

#### Scenario: US25-R14 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: recover a change after a lost response, so that I do not accidentally submit it twice. The exact shared and domain contract sections RC07, RC25 define the applicable source and scope limits.

#### Scenario: US25-R15 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: leave an unaccepted edit and still reach protective actions, so that unfinished input does not trap me or silently undo accepted work. The exact shared and domain contract sections RC06, RC07, RC20 define the applicable source and scope limits.

#### Scenario: US25-R16 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: start Replace from the exact saved method and see its qualified uses, so that I know which gifts are candidates without guessing from a card mask. The exact shared and domain contract sections RC02, RC09 define the applicable source and scope limits.

#### Scenario: US25-R17 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: adjust the eligible replacement selection deliberately, so that unselected or newly discovered gifts do not change unexpectedly. The exact shared and domain contract sections RC09 define the applicable source and scope limits.

#### Scenario: US25-R18 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: choose a compatible saved method or securely add one inside Replace, so that I can finish without duplicating setup or losing the selected task. The exact shared and domain contract sections RC08, RC09 define the applicable source and scope limits.

#### Scenario: US25-R19 independently verifiable outcome
...
The system SHALL support the following observable outcome for the financial authorizer: authorize each selected recurring group accurately, so that one convenient review does not become blanket collection authority. The exact shared and domain contract sections RC02, RC10 define the applicable source and scope limits.

#### Scenario: US25-R20 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: have my complete accepted replacement selection recorded before work begins, so that partial progress cannot lose what I approved. The exact shared and domain contract sections RC10, RC25 define the applicable source and scope limits.

#### Scenario: US25-R21 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: replace only the selected compatible uses without unintended collections, so that future binding maintenance does not create extra payments. The exact shared and domain contract sections RC11 define the applicable source and scope limits.

#### Scenario: US25-R22 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: see individual confirmed and unresolved replacement results, so that I can recover remaining work without repeating successful changes. The exact shared and domain contract sections RC07, RC10, RC11 define the applicable source and scope limits.

#### Scenario: US25-R23 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: understand when an in-place credential edit affects shared uses, so that deselection does not promise an isolation the provider cannot supply. The exact shared and domain contract sections RC11 define the applicable source and scope limits.

#### Scenario: US25-R24 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: remove a saved method only after real live dependencies are safe, so that paused, pending or hidden uses do not break silently. The exact shared and domain contract sections RC12 define the applicable source and scope limits.

#### Scenario: US25-R25 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: return from replacement to a separate current Remove review, so that I can replace gifts without being forced to delete the old method. The exact shared and domain contract sections RC09, RC12 define the applicable source and scope limits.

#### Scenario: US25-R26 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: recover an uncertain removal safely, so that a timeout does not trigger another detach or a false success. The exact shared and domain contract sections RC12, RC25 define the applicable source and scope limits.

#### Scenario: US25-R27 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: retain newer preferences when an old method removal finishes, so that late cleanup cannot erase my current choice. The exact shared and domain contract sections RC12, RC14 define the applicable source and scope limits.

#### Scenario: US25-R28 independently verifiable outcome
...
The system SHALL support the following observable outcome for the first-time donor or authorized representative: save a payment method without first making a gift, so that the wallet works before any financial history exists. The exact shared and domain contract sections RC02, RC08, RC13 define the applicable source and scope limits.

#### Scenario: US25-R29 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: optionally prefer a new method while saving it, so that I can express a convenience choice without changing existing giving. The exact shared and domain contract sections RC13 define the applicable source and scope limits.

#### Scenario: US25-R30 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor or treasurer: keep my preferred method personal to my exact giving context, so that another actor, organization or account does not inherit it. The exact shared and domain contract sections RC02, RC13 define the applicable source and scope limits.

#### Scenario: US25-R31 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor verifying a bank method: know whether my optional preference is pending and when it expires, so that verification delay does not lose or misrepresent my choice. The exact shared and domain contract sections RC08, RC14 define the applicable source and scope limits.

#### Scenario: US25-R32 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: change, reaffirm, clear or withdraw a pending preference predictably, so that late events do not undo my latest instruction. The exact shared and domain contract sections RC14 define the applicable source and scope limits.

#### Scenario: US25-R33 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: choose saved, new or Express payment through one secure checkout, so that the convenient starting choice never bypasses financial review. The exact shared and domain contract sections RC08, RC15 define the applicable source and scope limits.

#### Scenario: US25-R34 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: receive separate truthful saving and preference results, so that one successful step is not undone because the other needs attention. The exact shared and domain contract sections RC08, RC14, RC15 define the applicable source and scope limits.

#### Scenario: US25-R35 independently verifiable outcome
...
The system SHALL support the following observable outcome for the returning donor: restart from the last agreed terms of my canceled gift, so that familiar suggestions are accurate rather than reconstructed from payments. The exact shared and domain contract sections RC16 define the applicable source and scope limits.

#### Scenario: US25-R36 independently verifiable outcome
...
The system SHALL support the following observable outcome for the returning donor: restart only the exact selected lines, so that shared historical charges do not select siblings or substitute ministries. The exact shared and domain contract sections RC02, RC16 define the applicable source and scope limits.

#### Scenario: US25-R37 independently verifiable outcome
...
The system SHALL support the following observable outcome for the returning donor: see all newly applicable defaults and optional end, so that same-as-before suggestions do not carry hidden old instructions. The exact shared and domain contract sections RC05, RC16 define the applicable source and scope limits.

#### Scenario: US25-R38 independently verifiable outcome
...
The system SHALL support the following observable outcome for the returning donor: review the actual initial charges and continuing schedule, so that a future start or twice-monthly plan never conceals a charge today. The exact shared and domain contract sections RC05, RC16 define the applicable source and scope limits.

#### Scenario: US25-R39 independently verifiable outcome
...
The system SHALL support the following observable outcome for the returning donor: recover an unresolved restart from any repeated entry, so that another tab or transport key cannot multiply initial gifts. The exact shared and domain contract sections RC17 define the applicable source and scope limits.

#### Scenario: US25-R40 independently verifiable outcome
...
The system SHALL support the following observable outcome for the returning donor: understand old in-flight payments separately from my new gift, so that restart never revives canceled authority or hides unresolved collection. The exact shared and domain contract sections RC16, RC17 define the applicable source and scope limits.

#### Scenario: US25-R41 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: choose a dated or indefinite pause in one straightforward form, so that I control the break without a guessed duration. The exact shared and domain contract sections RC18 define the applicable source and scope limits.

#### Scenario: US25-R42 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: see payments before and after a scheduled pause, so that a future start or short pause has no concealed financial effect. The exact shared and domain contract sections RC18 define the applicable source and scope limits.

#### Scenario: US25-R43 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: have pause boundaries preserve my existing schedule, so that a break suppresses gifts rather than creates debt or date drift. The exact shared and domain contract sections RC05, RC18, RC19 define the applicable source and scope limits.

#### Scenario: US25-R44 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor whose initial bank gift is processing: pause future giving before activation finishes, so that I can protect future intent without pretending the initial payment stopped. The exact shared and domain contract sections RC17, RC19 define the applicable source and scope limits.

#### Scenario: US25-R45 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: have my agreed final horizon apply in every state, so that paused or pending giving cannot restart after its authorized end. The exact shared and domain contract sections RC19, RC20 define the applicable source and scope limits.

#### Scenario: US25-R46 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: resume with a clear review of any eligible gift today, so that the same gesture cannot silently re-anchor or collect missed gifts. The exact shared and domain contract sections RC20 define the applicable source and scope limits.

#### Scenario: US25-R47 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with a dated pause: resume automatically only while current conditions permit it, so that stored timers cannot collect through changed authority or controls. The exact shared and domain contract sections RC19, RC20 define the applicable source and scope limits.

#### Scenario: US25-R48 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: skip an eligible gift or cancel directly, so that I can stop future intent without a forced retention journey. The exact shared and domain contract sections RC07, RC20 define the applicable source and scope limits.

#### Scenario: US25-R49 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor completing a payment repair: know whether the full original task is actually finished, so that a saved or verified method is not mistaken for repaired recurring giving. The exact shared and domain contract sections RC07, RC08, RC21 define the applicable source and scope limits.

#### Scenario: US25-R50 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor after a fully qualified repair: receive one quiet relevant review link when appropriate, so that I can consider the earlier failed gift without a debt or batch demand. The exact shared and domain contract sections RC21 define the applicable source and scope limits.

#### Scenario: US25-R51 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: finish or review a repair without accidentally stopping or initiating payment, so that navigation and consequential recovery remain clearly different. The exact shared and domain contract sections RC21 define the applicable source and scope limits.

#### Scenario: US25-R52 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with a card recovery opportunity: retry only the originally eligible scheduled gift, so that manual action cannot race automation or add recovery capacity. The exact shared and domain contract sections RC22 define the applicable source and scope limits.

#### Scenario: US25-R53 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with an established returned bank gift: receive only the supported exact bank recovery option, so that card retry behavior is never copied into ACH. The exact shared and domain contract sections RC22 define the applicable source and scope limits.

#### Scenario: US25-R54 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor without fixed pledges: see no unsolicited fixed-pledge interface, so that an uncommon feature does not clutter my account or disclose hidden records. The exact shared and domain contract sections RC02, RC23 define the applicable source and scope limits.

#### Scenario: US25-R55 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with a fixed campaign commitment: read my pledge and received-and-applied amount in a simple list, so that a promise is not mistaken for payment or debt. The exact shared and domain contract sections RC23 define the applicable source and scope limits.

#### Scenario: US25-R56 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with a fixed pledge: inspect actual plans and linked gifts or recurring arrangements, so that relationships do not invent dates, payments or extra access. The exact shared and domain contract sections RC02, RC23 define the applicable source and scope limits.

#### Scenario: US25-R57 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with a fixed pledge: send a concise change request and recover its receipt, so that I can ask staff without directly editing financial terms. The exact shared and domain contract sections RC24, RC25 define the applicable source and scope limits.

#### Scenario: US25-R58 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor who does not recognize a fixed commitment: send the exact commitment for protective authority review, so that disputing it does not require proving its original validity. The exact shared and domain contract sections RC02, RC24 define the applicable source and scope limits.

#### Scenario: US25-R59 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor and authorized pledge reviewer: understand request progress and its bounded private text custody, so that silence, reading or expiry cannot masquerade as a completed change. The exact shared and domain contract sections RC24, RC26 define the applicable source and scope limits.

#### Scenario: US25-R60 independently verifiable outcome
...
The system SHALL support the following observable outcome for the qualified pledge service contact: stop my own eligible reminders, so that stopping contact changes neither pledge nor another recipient preference. The exact shared and domain contract sections RC24 define the applicable source and scope limits.

#### Scenario: US25-R61 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor or representative: have every financial view and command honor current access, so that URLs, caches and privileged paths do not leak or move my data. The exact shared and domain contract sections RC02, RC25, RC26 define the applicable source and scope limits.

#### Scenario: US25-R62 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor using mobile or assistive technology: complete every reviewed journey with readable controls and stable focus, so that essential actions work without visual, keyboard or bandwidth barriers. The exact shared and domain contract sections RC04, RC06, RC08, RC18, RC23, RC28 define the applicable source and scope limits.

#### Scenario: US25-R63 independently verifiable outcome
...
The system SHALL support the following observable outcome for the source operations owner: diagnose delayed or inconsistent work through bounded existing operations, so that routine repairs do not require database editing or repeat payments. The exact shared and domain contract sections RC26, RC27 define the applicable source and scope limits.

#### Scenario: US25-R64 independently verifiable outcome
...
The system SHALL support the following observable outcome for the release engineer: verify complete donor outcomes at the approved test seams, so that mocked success cannot activate an unqualified financial or document lane. The exact shared and domain contract sections RC25, RC27, RC28 define the applicable source and scope limits.

#### Scenario: US25-R65 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: retain truthful history and safe access through changes or rollout incidents, so that containment does not undo giving or restore unsafe old controls. The exact shared and domain contract sections RC01, RC07, RC17, RC19, RC27 define the applicable source and scope limits.

#### Scenario: US25-R66 independently verifiable outcome
...
The system SHALL support the following observable outcome for the financial authorizer or receipt recipient: receive only qualified required communications for my exact purpose, so that quiet settings neither suppress mandatory notices nor create message spam. The exact shared and domain contract sections RC26 define the applicable source and scope limits.

#### Scenario: US25-R67 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor and privacy/source operator: have each deadline apply only to its actual purpose, so that temporary choices expire without erasing financial evidence or reviving stale authority. The exact shared and domain contract sections RC07, RC14, RC24, RC26, RC27 define the applicable source and scope limits.

#### Scenario: US25-R68 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: see only my currently authorized financial context, so that I can trust whose records I am viewing. The exact shared and domain contract sections D01 define the applicable source and scope limits.

#### Scenario: US25-D01 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with limited record rights: see only independently permitted amounts and labels, so that hidden ministry or family facts stay private. The exact shared and domain contract sections D01 define the applicable source and scope limits.

#### Scenario: US25-D02 independently verifiable outcome
...
The system SHALL support the following observable outcome for the finance operator: have donor views agree with the same source revision, so that I can investigate discrepancies without editing portal totals. The exact shared and domain contract sections D01, D19 define the applicable source and scope limits.

#### Scenario: US25-D03 independently verifiable outcome
...
The system SHALL support the following observable outcome for the international donor: read exact original currency values, so that my gifts are not rounded or converted incorrectly. The exact shared and domain contract sections D01, D11 define the applicable source and scope limits.

#### Scenario: US25-D04 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: recognize a split gift as one gift, so that I do not reconstruct it from transaction fragments. The exact shared and domain contract sections D02 define the applicable source and scope limits.

#### Scenario: US25-D05 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor whose bank payment is processing: see the actual recorded outcome, so that I know the instruction was accepted without being told money has arrived. The exact shared and domain contract sections D02, D12 define the applicable source and scope limits.

#### Scenario: US25-D06 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor whose gift changes: understand original and current facts together, so that a refund or return is not mistaken for a failed gift. The exact shared and domain contract sections D02 define the applicable source and scope limits.

#### Scenario: US25-D07 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with two identical payments: retain both real gifts, so that similar dates and amounts do not merge my history. The exact shared and domain contract sections D02 define the applicable source and scope limits.

#### Scenario: US25-D08 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with offline or imported gifts: find all source-qualified records available here, so that platform entry method does not erase legitimate history. The exact shared and domain contract sections D02 define the applicable source and scope limits.

#### Scenario: US25-D09 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with noncash giving: see useful records without fabricated values, so that internal valuations are not confused with money or deductions. The exact shared and domain contract sections D02, D12 define the applicable source and scope limits.

#### Scenario: US25-D10 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: open a gift directly and return to my place, so that reviewing details is effortless. The exact shared and domain contract sections D03, D05 define the applicable source and scope limits.

#### Scenario: US25-D11 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: find new changes to an older gift, so that important corrections are not buried. The exact shared and domain contract sections D03 define the applicable source and scope limits.

#### Scenario: US25-D12 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor on an unreliable connection: distinguish missing records from failed loading, so that I can recover without giving again. The exact shared and domain contract sections D03 define the applicable source and scope limits.

#### Scenario: US25-D13 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor seeking help: reach the organization with relevant permitted context, so that I do not expose sensitive screenshots or processor identifiers. The exact shared and domain contract sections D03, D07 define the applicable source and scope limits.

#### Scenario: US25-D14 independently verifiable outcome
...
The system SHALL support the following observable outcome for the returning donor: start History with all available records, so that January does not make older gifts disappear. The exact shared and domain contract sections D04 define the applicable source and scope limits.

#### Scenario: US25-D15 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: choose readable date periods, so that I know exactly which dates are included. The exact shared and domain contract sections D04 define the applicable source and scope limits.

#### Scenario: US25-D16 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: filter several funds together, so that I can find the gifts connected to my chosen ministries. The exact shared and domain contract sections D04 define the applicable source and scope limits.

#### Scenario: US25-D17 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: filter by the amount I originally supported, so that fee cover or refunds do not change what the filter means. The exact shared and domain contract sections D04 define the applicable source and scope limits.

#### Scenario: US25-D18 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor using multiple currencies: choose currency with amount bounds, so that the query cannot silently convert my choices. The exact shared and domain contract sections D04 define the applicable source and scope limits.

#### Scenario: US25-D19 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: apply or discard filter edits predictably, so that closing a form cannot change my history. The exact shared and domain contract sections D04 define the applicable source and scope limits.

#### Scenario: US25-D20 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with an invalid filter: correct my input without losing it, so that errors do not silently broaden the result. The exact shared and domain contract sections D04 define the applicable source and scope limits.

#### Scenario: US25-D21 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: use relevant secondary filters or find a gift, so that I can narrow history without a staff query builder. The exact shared and domain contract sections D04 define the applicable source and scope limits.

#### Scenario: US25-D22 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with long history: continue reading and scroll backward reliably, so that a large account remains usable. The exact shared and domain contract sections D05 define the applicable source and scope limits.

#### Scenario: US25-D23 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: keep meaningful position when history updates, so that new data does not interrupt what I am reading. The exact shared and domain contract sections D05 define the applicable source and scope limits.

#### Scenario: US25-D24 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor changing accounts: have private working data retired, so that old records cannot appear in the new context. The exact shared and domain contract sections D05 define the applicable source and scope limits.

#### Scenario: US25-D25 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: find statements and receipts directly, so that I do not have to search transaction history first. The exact shared and domain contract sections D06 define the applicable source and scope limits.

#### Scenario: US25-D26 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with several official documents: recognize the right document, so that copies and retries do not look like additional receipts. The exact shared and domain contract sections D06 define the applicable source and scope limits.

#### Scenario: US25-D27 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with an optional support overview: distinguish it from official tax records, so that recognition is not confused with legal giving. The exact shared and domain contract sections D06, D15 define the applicable source and scope limits.

#### Scenario: US25-D28 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: view, download and print available documents, so that I can keep my records without contacting staff. The exact shared and domain contract sections D06, D07 define the applicable source and scope limits.

#### Scenario: US25-D29 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor whose statement section fails: keep using my available receipts, so that one failure does not block the entire document area. The exact shared and domain contract sections D07 define the applicable source and scope limits.

#### Scenario: US25-D30 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor awaiting a correction: get the current valid document, so that pending replacement does not serve an invalid fallback. The exact shared and domain contract sections D07 define the applicable source and scope limits.

#### Scenario: US25-D31 independently verifiable outcome
...
The system SHALL support the following observable outcome for the recipient of a document link: reach only the permitted document, so that an exact handoff cannot expose an account library. The exact shared and domain contract sections D07 define the applicable source and scope limits.

#### Scenario: US25-D32 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor needing another copy: request it only through the qualified document action, so that ordinary viewing never sends unexpected mail. The exact shared and domain contract sections D07 define the applicable source and scope limits.

#### Scenario: US25-D33 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with historical records: retain legitimate artifact access during rollout, so that new issuance darkness does not erase valid documents. The exact shared and domain contract sections D06, D07 define the applicable source and scope limits.

#### Scenario: US25-D34 independently verifiable outcome
...
The system SHALL support the following observable outcome for the recurring donor: quiet eligible routine receipt emails, so that I can reduce noise while keeping my acknowledgments. The exact shared and domain contract sections D08 define the applicable source and scope limits.

#### Scenario: US25-D35 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor managing another legal donor: understand which receipt preference changes, so that my personal settings and represented giving do not mix. The exact shared and domain contract sections D08 define the applicable source and scope limits.

#### Scenario: US25-D36 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: see and save the actual receipt-email choice, so that a local toggle cannot pretend the server accepted it. The exact shared and domain contract sections D08 define the applicable source and scope limits.

#### Scenario: US25-D37 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor turning routine emails off: understand prospective delivery, so that already queued mail is not a broken promise. The exact shared and domain contract sections D08 define the applicable source and scope limits.

#### Scenario: US25-D38 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor filing before annual statements are ready: obtain the needed acknowledgment, so that quieting does not postpone documentation. The exact shared and domain contract sections D08, D07 define the applicable source and scope limits.

#### Scenario: US25-D39 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: download the scope I am currently viewing, so that the file does not unexpectedly include different gifts. The exact shared and domain contract sections D09 define the applicable source and scope limits.

#### Scenario: US25-D40 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: adjust only my download filters, so that my browsing place and filters remain intact. The exact shared and domain contract sections D09 define the applicable source and scope limits.

#### Scenario: US25-D41 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor reviewing an annual summary: download the same financial meaning, so that the file can explain the summary. The exact shared and domain contract sections D09, D12 define the applicable source and scope limits.

#### Scenario: US25-D42 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: start one recoverable file preparation, so that double clicks and a lost response do not create duplicate jobs. The exact shared and domain contract sections D10 define the applicable source and scope limits.

#### Scenario: US25-D43 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: leave preparation running or cancel it explicitly, so that closing a window cannot cancel giving. The exact shared and domain contract sections D10 define the applicable source and scope limits.

#### Scenario: US25-D44 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor: receive a complete file, so that a success state never hides truncation. The exact shared and domain contract sections D10 define the applicable source and scope limits.

#### Scenario: US25-D45 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor returning to a prepared file: recognize its original scope and availability, so that a prior result cannot replace my current intent. The exact shared and domain contract sections D09, D10 define the applicable source and scope limits.

#### Scenario: US25-D46 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor downloading over a poor connection: retry the exact same authorized file, so that recovery cannot splice or regenerate its contents. The exact shared and domain contract sections D10 define the applicable source and scope limits.

#### Scenario: US25-D47 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor whose permissions change: have future file access reflect current rights, so that an older file cannot bypass a new restriction. The exact shared and domain contract sections D10 define the applicable source and scope limits.

#### Scenario: US25-D48 independently verifiable outcome
...
The system SHALL support the following observable outcome for the export operator: dispose of temporary files without losing business records, so that privacy cleanup cannot alter giving. The exact shared and domain contract sections D10, D19 define the applicable source and scope limits.

#### Scenario: US25-D49 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor opening a spreadsheet: read exact safe values, so that names or large identifiers cannot execute formulas or silently round. The exact shared and domain contract sections D11 define the applicable source and scope limits.

#### Scenario: US25-D50 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor reading Home: understand this year so far, so that a simple amount has a clear basis. The exact shared and domain contract sections D12 define the applicable source and scope limits.

#### Scenario: US25-D51 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor supporting organizations in different timezones: see the correct calendar periods, so that midnight does not misdate my giving. The exact shared and domain contract sections D12 define the applicable source and scope limits.

#### Scenario: US25-D52 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor whose older gift is refunded: see the correct current-effective cohort, so that refund date is not confused with gift date. The exact shared and domain contract sections D12 define the applicable source and scope limits.

#### Scenario: US25-D53 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor whose annual amount is zero: retain useful context and older access, so that I am not incorrectly treated as a new or lapsed donor. The exact shared and domain contract sections D12 define the applicable source and scope limits.

#### Scenario: US25-D54 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor checking an annual amount: open matching History and then broaden it, so that the drill-through stays understandable. The exact shared and domain contract sections D09, D12 define the applicable source and scope limits.

#### Scenario: US25-D55 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with an employer match: see known recorded progress and actual funds, so that I do not mistake an internal record for employer approval. The exact shared and domain contract sections D13 define the applicable source and scope limits.

#### Scenario: US25-D56 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor without a visible original gift: find my admitted matching record, so that legitimate external matches are still understandable. The exact shared and domain contract sections D13 define the applicable source and scope limits.

#### Scenario: US25-D57 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with a partial or reversed match: see truthful current received facts, so that changes do not reverse my own gift or create debt. The exact shared and domain contract sections D13, D14 define the applicable source and scope limits.

#### Scenario: US25-D58 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor viewing older matching history: keep stable access without noise, so that a note edit does not rearrange my account. The exact shared and domain contract sections D13 define the applicable source and scope limits.

#### Scenario: US25-D59 independently verifiable outcome
...
The system SHALL support the following observable outcome for the matching operations staff: record or correct actual source truth atomically, so that donor views cannot contradict settlements. The exact shared and domain contract sections D14 define the applicable source and scope limits.

#### Scenario: US25-D60 independently verifiable outcome
...
The system SHALL support the following observable outcome for the matching operations staff: merge or reimport a genuine duplicate safely, so that prior receipt history and totals survive. The exact shared and domain contract sections D14 define the applicable source and scope limits.

#### Scenario: US25-D61 independently verifiable outcome
...
The system SHALL support the following observable outcome for the DAF advisor: see received grants attributed to me, so that I can recognize support without confusing it with personal receipts. The exact shared and domain contract sections D15 define the applicable source and scope limits.

#### Scenario: US25-D62 independently verifiable outcome
...
The system SHALL support the following observable outcome for the DAF advisor unfamiliar with tax terminology: understand why grants are absent from my annual contribution statement, so that I do not expect another deduction. The exact shared and domain contract sections D15 define the applicable source and scope limits.

#### Scenario: US25-D63 independently verifiable outcome
...
The system SHALL support the following observable outcome for the DAF advisor with partial recognition: avoid mistaking attributed credit for the full grant, so that my view does not overstate support or reveal others. The exact shared and domain contract sections D15 define the applicable source and scope limits.

#### Scenario: US25-D64 independently verifiable outcome
...
The system SHALL support the following observable outcome for the DAF advisor returning to older grants: read stable corrected history, so that date uncertainty does not hide records. The exact shared and domain contract sections D15 define the applicable source and scope limits.

#### Scenario: US25-D65 independently verifiable outcome
...
The system SHALL support the following observable outcome for the ordinary donor without rare records: see no DAF, QCD or matching artifacts, so that my account stays calm and relevant. The exact shared and domain contract sections D13, D15, D17 define the applicable source and scope limits.

#### Scenario: US25-D66 independently verifiable outcome
...
The system SHALL support the following observable outcome for the finance staff receiving an IRA gift: record the owner, custodian and intent distinctly, so that the gift receives the correct acknowledgment. The exact shared and domain contract sections D16 define the applicable source and scope limits.

#### Scenario: US25-D67 independently verifiable outcome
...
The system SHALL support the following observable outcome for the finance staff with incomplete QCD evidence: preserve money while resolving the case, so that document readiness does not drive financial truth. The exact shared and domain contract sections D16 define the applicable source and scope limits.

#### Scenario: US25-D68 independently verifiable outcome
...
The system SHALL support the following observable outcome for the IRA donor: understand my recorded intended QCD, so that the portal does not claim to determine my tax treatment. The exact shared and domain contract sections D17 define the applicable source and scope limits.

#### Scenario: US25-D69 independently verifiable outcome
...
The system SHALL support the following observable outcome for the IRA donor: obtain my separate acknowledgment, so that I have the right document even when annual totals differ. The exact shared and domain contract sections D17, D07 define the applicable source and scope limits.

#### Scenario: US25-D70 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor with ordinary and IRA giving: understand different summary and document totals, so that informational giving is not mistaken for deductible giving. The exact shared and domain contract sections D17, D12 define the applicable source and scope limits.

#### Scenario: US25-D71 independently verifiable outcome
...
The system SHALL support the following observable outcome for the release owner: activate only qualified source-backed capabilities, so that a polished screen cannot certify missing authority. The exact shared and domain contract sections D18 define the applicable source and scope limits.

#### Scenario: US25-D72 independently verifiable outcome
...
The system SHALL support the following observable outcome for the donor using assistive technology: complete record and document tasks without confusion, so that the polished UI remains usable for me. The exact shared and domain contract sections D03, D06, D18 define the applicable source and scope limits.

#### Scenario: US25-D73 independently verifiable outcome
...
The system SHALL support the following observable outcome for the operations owner: detect and repair exact source failures, so that donors are not asked to correct the system. The exact shared and domain contract sections D19 define the applicable source and scope limits.

#### Scenario: US25-D74 independently verifiable outcome
