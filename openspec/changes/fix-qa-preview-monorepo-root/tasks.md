...
- [x] 1.1 Reproduce the duplicate root and file-count failures with the authenticated CLI.
- [x] 1.2 Verify each existing project root and retain failing workflow regression evidence.
- [x] 1.3 Correct all three preview commands and verify focused tests.
