...
> (`add-eve-audit-tracer-bullet`, ADR-0020), and **#420** (`add-eve-kill-switch-control-path`, EVE-DESIGN-0004) —
...
- Provisional Eve design decision `EVE-DESIGN-0006` for the model policy, traceable from ADR-0019 (#418), ADR-0020 (#419), and EVE-DESIGN-0004
  (#420).
