...
> ADR-0001), **#418** (`add-eve-governance-kernel-release-switch`, ADR-0002), **#419**
> (`add-eve-audit-tracer-bullet`, ADR-0003), and **#420** (`add-eve-kill-switch-control-path`, ADR-0004) —
...
- Record the decision as **ADR-0006** in this change's `design.md`, building on ADR-0002 (#418), ADR-0003
  (#419), and ADR-0004 (#420), all of which build on ADR-0001 (#417).
...
- ADR-0006 of record for the model policy, traceable from ADR-0002 (#418), ADR-0003 (#419), and ADR-0004
  (#420).
