...
> ADR-0020), **#423** (`add-eve-approval-budget-policy`, EVE-DESIGN-0005), **#425** (`add-eve-runtime-foundation`,
...
- Record the decision under provisional Eve design label **EVE-DESIGN-0012** in this change's `design.md`, building on ADR-0020 (#419), EVE-DESIGN-0005
...
- Provisional Eve design decision `EVE-DESIGN-0012` for the GitHub read and review path, traceable from ADR-0020 (#419), EVE-DESIGN-0005 (#423),
