...
- Inventory existing findings, fix bounded safe usages, and represent
  remaining debt explicitly without silently expanding accepted debt.
...
scoped agent guidance, and bounded UI corrections. Runtime packages,
production data, secrets, deployments, unrelated framework migrations,
