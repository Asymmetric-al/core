...
- AND they treat product-facing surface split and shared logic convergence as
...
**Migration**: Use **CRM As Operational Truth And CMS As Public Truth**,
**CRM/CMS Alignment As A Core Platform Contract**, and **Server-Side Boundary
...
**Migration**: Use **Monorepo Surface Split And Shared Logic Convergence** and
...
- THEN they use the new requirements for shared logic convergence and truth
  ownership
- AND they keep detailed package placement rules in architecture docs instead of
  this boundary spec
...
**Migration**: Use **Role-Scoped Surface Boundaries** and **Public Versus
...
**Migration**: Use **Server-Side Boundary For Sensitive Operations** and
...
- GIVEN a contributor expects the old “Next.js Runtime And Caching Posture”
  heading
- WHEN they search this spec after the change merges
- THEN they use repo runtime guidance outside this spec for framework behavior
- AND they keep this boundary spec focused on structural and trust contracts
