...
## 2. Canonical skills and routing
...
- [x] 3.1 Run the canonical skill sync and drift verification.
- [x] 3.2 Validate skill metadata, formatting, and the OpenSpec change.
- [x] 3.3 Review the final diff for generated parity, conflicts, pnpm changes,
      dependency changes, and Eve/runtime scope.
