...
donor address/location, phone, gift date range, Stripe PaymentIntent, charge,
refund or replay identifiers, payment method, payment type, safe last-four,
status, receipt state, refund state, designation, fund, missionary, project,
batch, and other contribution fields when available.
...
- THEN the product gives staff a gift-first path to find the relevant
  contribution without needing to leave Mission Control
