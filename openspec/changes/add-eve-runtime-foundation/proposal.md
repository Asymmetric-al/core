...
> ADR-0018), **#421** (`add-eve-model-policy-tracer`, ADR-0022), and **#423** (`add-eve-approval-budget-policy`,
...
- Provisional Eve design decision `EVE-DESIGN-0007` for the runtime foundation, traceable from ADR-0018 (#417), EVE-DESIGN-0005 (#423), and ADR-0022
  (#421).
