...
We provide security updates only for the **latest stable release** of this project.
...
- Provide a **status update** at least every **7 days** while investigating
- Work toward a fix and release. Typical target is **30 days**, but severe issues may be faster and complex issues may take longer.
...
- Supply-chain issues that affect this project (e.g., a vulnerable dependency that is reachable/exploitable through normal usage)
...
- Only test against systems/accounts they own or have explicit permission to test
- Stop testing and report promptly if they encounter sensitive data

This safe-harbor guidance does not authorize accessing data that is not yours or engaging in activity that is unlawful.
