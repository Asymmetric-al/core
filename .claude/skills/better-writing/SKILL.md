...
Use this copy companion with `better-interface`. Product
voice and existing UI strings still win over generic marketing tone.
...
- Reviewing or tightening interface copy in a UI change.
- `better-interface` needs the dedicated writing skill.

### Workflow

1. Keep existing Core product voice and tenant-safe language.
2. Do not invent a new marketing tone for Mission Control, donor, or
   missionary surfaces.
3. Pair with `base-maia` components rather than restyling around copy.

### Checklist

- [ ] Existing product voice was preserved.
- [ ] Copy review did not become a visual redesign.
