...
source_path: skills/better-typography/
...
# Upstream: better-typography

Canonical copy in this repo: `docs/ai/skills/better-typography/`, mirrored to
...
1. Refresh the lockfile-managed skill with a targeted Skills CLI add:
   `npx skills add jakubkrehel/skills --skill better-typography -y`.
