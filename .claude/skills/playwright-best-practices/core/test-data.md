...
test("create user with fake data", async ({ page, fake }) => {
  ...
  await page.getByLabel("Password").fill(fake.internet.password()); // pragma: allowlist secret
...
const loginScenarios = [
  { email: "user@example.com", password: "pass123", expected: "Dashboard" }, // pragma: allowlist secret
  { email: "admin@example.com", password: "admin123", expected: "Admin Panel" }, // pragma: allowlist secret
  {
