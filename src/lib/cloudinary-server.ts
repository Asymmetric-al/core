 ...
 */
export function generateCloudinarySignature(params: Record<string, any>): CloudinarySignature {
  ...
  const signatureString = sortedKeys
    .filter(key => signatureParams[key] !== undefined && signatureParams[key] !== null && signatureParams[key] !== '')
...
export const isCloudinaryEnabled = process.env.NEXT_PUBLIC_CLOUDINARY_ENABLED === 'true'
