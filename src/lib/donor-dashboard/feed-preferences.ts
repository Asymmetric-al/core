...
export async function getDonorFeedPreferences(donorId: string, tenantId: string): Promise<DonorFeedPreferences | null> {
...
export async function getOrgPostVisibility(tenantId: string): Promise<OrgPostVisibility> {
  const supabase = await createClient()
...
export async function updateOrgPostVisibility(tenantId: string, visibility: OrgPostVisibility): Promise<void> {
  const supabase = await createClient()
