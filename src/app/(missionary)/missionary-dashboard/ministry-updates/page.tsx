            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                {request.is_donor && (
                  ...
                  <TimeAgo date={request.created_at} className="text-[9px] text-muted-foreground" />
                </div>
            </div>
          </div>
              ...
              {isLoadingRequests ? (
                ...
                >
                  <motion.div 
                    ...
                    animate={{ scale: 1 }}
                    transition={springTransition}
                    className="w-10 h-10 bg-muted rounded-full flex items-center justify-center mx-auto mb-3"
                  >
