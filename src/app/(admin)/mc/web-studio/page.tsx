...
const PreviewContent = ({
  ...
  return (
    <div className="bg-white min-h-full font-sans text-slate-900 pb-10 text-left">
      ...
      <div
        className={cn(
          "bg-slate-100 w-full relative overflow-hidden shrink-0 group",
      ...
      >
        <div
          className={cn(
            ...
            mode === "mobile" ? "h-20 w-20 mx-auto" : "h-32 w-32",
          )}
        >
          <Image
            src={profileImage}
        ...
        >
          ...
          >
            <Button
              size="sm"
              className="rounded-full bg-slate-900 text-white font-bold uppercase tracking-wider text-[10px] h-8 px-6 shadow-md"
            >
              Give Support
            </Button>
            <Button
      ...
      <header className="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-4 shrink-0 z-20 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          >
            <TabsList className="bg-transparent h-full p-0 gap-4 border-none">
              <TabsTrigger
                value="content"
                className="bg-transparent border-b-2 border-transparent data-[state=active]:border-slate-900 data-[state=active]:text-slate-900 rounded-none px-0 py-2 text-[11px] font-bold uppercase tracking-wider text-slate-400 shadow-none"
              >
                Live Content
              </TabsTrigger>
              <TabsTrigger
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="sm"
            className="h-8 bg-white border-slate-200 text-slate-600 text-[10px] font-bold uppercase tracking-wider"
          >
          ...
          <Button
            ...
            onClick={handleSave}
            disabled={isSaving}
            className="h-8 px-4 font-bold uppercase tracking-wider text-[10px] bg-slate-900 hover:bg-slate-800"
          >
            {isSaving ? (
          ...
          <div className="p-8 max-w-3xl mx-auto space-y-10">
            {view === "content" ? (
              <div className="space-y-6">
                <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400 text-left border-b border-slate-100 pb-2">
                  Global Branding
                </h3>
                <div className="grid grid-cols-2 gap-6 text-left">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-10 bg-slate-50 border-slate-200 font-bold"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-bold uppercase tracking-wider text-slate-500">
                ...
                <div className="space-y-2 text-left">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <div className="flex gap-1">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-6 text-[9px] font-bold uppercase tracking-wider gap-1 border border-purple-100 bg-purple-50 text-purple-700"
                      >
                  ...
                  <Textarea
                    ...
                    className="min-h-[150px] bg-slate-50 border-slate-200 leading-relaxed text-sm font-medium"
                  />
                </div>
              </div>
            ) : view === "projects" ? (
              <div className="space-y-6 text-left">
                <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400 text-left border-b border-slate-100 pb-2 flex items-center justify-between">
                  ...
                  <Button
                    size="sm"
                    className="h-7 px-3 text-[10px] font-bold uppercase tracking-wider bg-slate-900 text-white shadow-sm"
                  >
                ...
                <div className="space-y-3">
                  {projects.map((p) => (
                    <div
                      key={p.id}
                      className="flex items-center justify-between p-4 rounded-xl border border-slate-200 bg-white hover:border-blue-300 hover:bg-blue-50/20 transition-all group"
                    >
              ...
              <div className="space-y-6 text-left">
                <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400 text-left border-b border-slate-100 pb-2 flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="h-7 px-3 text-[10px] font-bold uppercase tracking-wider bg-slate-900 text-white shadow-sm"
                  >
                    <Plus className="h-3 w-3 mr-1" /> New Update
                  </Button>
                </h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="p-4 rounded-xl border border-slate-200 bg-white hover:border-blue-300 transition-all group"
                    >
                      <div className="flex justify-between items-start">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            ...
                            <Badge
                              variant="secondary"
                              className="text-[9px] h-4 font-bold uppercase tracking-widest px-1.5"
                            >
                              {upd.type}
                            </Badge>
                          </div>
            ...
            {previewMode === "mobile" ? (
              ...
              <div className="w-full h-full rounded-xl border border-slate-200 bg-white shadow-2xl overflow-hidden flex flex-col">
                <div className="h-8 border-b border-slate-100 flex items-center px-3 gap-1.5 shrink-0 bg-slate-50/50">
                  ...
                  <div className="mx-auto bg-white border border-slate-200 rounded h-5 w-48 text-[8px] font-mono flex items-center justify-center text-slate-400">
