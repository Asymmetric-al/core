...
import { PDFStudioSetupStatus } from '@/components/studio/PDFStudioSetupStatus'
import { getPDFStudioConfig, type PDFStudioFullConfig } from '@/config/pdf-studio'
...
import { PDF_TEMPLATE_CATEGORIES, PAGE_SIZES, ORIENTATIONS } from '@/types/pdf-studio'
import { 
  FileText, 
  Save, 
  Download, 
...
export default function PDFStudio() {
  ...
  const [studioConfig, setStudioConfig] = useState<PDFStudioFullConfig | null>(null)
  const [isFullscreen, setIsFullscreen] = useState(false)
  const [copiedHtml, setCopiedHtml] = useState(false)
  const [currentDesign, setCurrentDesign] = useState<UnlayerDesignJSON | null>(null)
  ...
  const handleExportPDF = useCallback(async () => {
    ...
    try {
      ...
      toast.error('Failed to export PDF', {
        description: 'PDF export requires an Unlayer project ID. Configure your Unlayer account for PDF export.'
      })
    } finally {
  ...
  }, [isEditorReady, isSaving, isFullscreen, handleSaveClick, handleUndo, handleRedo, handleExportHtml, handleExportPDF])

  const handleEditorReady = useCallback((config: PDFStudioFullConfig | EmailStudioFullConfig) => {
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => toast.info('Print functionality coming soon')}>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52">
              ...
              <DropdownMenuItem onClick={() => toast.info('Template settings coming soon')}>
                <Settings className="h-4 w-4 mr-2" />
                Settings
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => toast.info('Load template coming soon')}>
      ...
      <Dialog open={showSaveDialog} onOpenChange={setShowSaveDialog}>
        <DialogContent className="sm:max-w-[520px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter the details for your PDF template. These will help organize your documents.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-5 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Select 
                  ...
                  onValueChange={(value: PDFTemplateCategory) => setMetadata(prev => ({ ...prev, category: value }))}
                >
              ...
              <div className="grid gap-2">
                ...
                <Select 
                  ...
                  onValueChange={(value: 'A4' | 'Letter' | 'Legal') => setMetadata(prev => ({ ...prev, pageSize: value }))}
                >
            ...
            <div className="grid gap-2">
              ...
              <Select 
                ...
                onValueChange={(value: 'portrait' | 'landscape') => setMetadata(prev => ({ ...prev, orientation: value }))}
              >
            ...
            <div className="grid gap-2">
              ...
              <p className="text-[11px] text-muted-foreground">
                A brief description helps team members understand when to use this template.
              </p>
            </div>
          </div>
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button onClick={handleConfirmSave} disabled={!metadata.name.trim() || isSaving}>
              {isSaving ? (
                <>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete &ldquo;{metadata.name}&rdquo;? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
