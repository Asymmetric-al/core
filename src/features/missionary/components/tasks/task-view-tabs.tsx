...
export type TaskView = 'all' | 'my_tasks' | 'due_today' | 'overdue' | 'upcoming' | 'completed'
...
export function TaskViewTabs({ currentView, onViewChange, counts }: TaskViewTabsProps) {
  return (
    <div className="w-full border-b bg-card">
      <div className="container">
        <nav className="relative flex gap-1 overflow-x-auto pb-0 scrollbar-hide" aria-label="Task views">
          {views.map((view) => {
