  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        variant === 'warning' && 'bg-amber-50 border-amber-200 text-amber-900 dark:bg-amber-950/30 dark:border-amber-800 dark:text-amber-200',
...
export function TaskStats({ stats, currentView, onViewChange }: TaskStatsProps) {
  return (
    <motion.div
