            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Badge variant="outline" className={cn(
                  ...
                  task.status === 'in_progress' && "bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-950 dark:text-blue-300",
                  task.status === 'waiting' && "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950 dark:text-amber-300",
                  task.status === 'completed' && "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950 dark:text-emerald-300",
                )}>
                ...
                <div className="p-3 sm:p-4 rounded-xl bg-muted/50 border flex items-center justify-between group hover:bg-muted transition-colors">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      {task.donor.email && (
                        <p className="text-xs text-muted-foreground truncate">{task.donor.email}</p>
                      )}
                    </div>
                  </div>
