...
export const MISSIONARIES: Missionary[] = [
  {
    ...
    notes:
      "The Miller family has been serving in Thailand since 2018. Strong supporters of local school programs. Annual furlough typically in June-August.",
  ...
  },
  {
    ...
    notes:
      "Dr. Smith is a board-certified family physician. Currently dealing with customs delays for medical supplies. Needs prayer support.",
  ...
  },
  {
    ...
    notes:
      "Michael leads refugee response operations. Fluent in Arabic and Greek. Strong organizational skills.",
  ...
  },
  {
    ...
    notes:
      "Olivia focuses on arts-based education. Currently facing financial stress due to inflation. Needs additional pastoral care.",
  ...
  },
  {
    ...
    notes:
      "William provides tech support and training for missionaries across Asia. Strong technical background. Good check-in frequency.",
  ...
  },
  {
    ...
    notes:
      "Jackson trains community health workers. Works closely with Dr. Sarah Smith. Strong local church connections.",
...
export const DONORS: Donor[] = [
  {
    ...
    notes:
      "Long-time supporter of the Miller family. Prefers email communication. Interested in education initiatives.",
  ...
  },
  {
    ...
    notes:
      "Director of Giving at TechFoundations. Interested in sustainable water projects. Q4 strategy meeting scheduled.",
  ...
  },
  {
    ...
    notes:
      "CEO of Global Ventures. Long-time supporter of educational initiatives in South America.",
  ...
  },
  {
    ...
    notes:
      "Passionate about healthcare missions. Supports Dr. Sarah Smith's clinic.",
  ...
  },
  {
    ...
    notes:
      "Hasn't given in 8 months. Previously supported Michael Chen's refugee ministry.",
    createdAt: "2020-01-15T00:00:00Z",
  ...
  },
  {
    ...
    notes:
      "Church partner supporting multiple missionaries. Pledge is currently past due - follow up needed.",
  ...
  },
  {
    ...
    notes:
      "Met at annual gala. Very interested in Latin American missions. Schedule follow-up call.",
...
export const STAFF: StaffMember[] = [
  ...
  },
  {
    ...
    notes:
      "Finance Director. Manages all financial reporting and donor receipts.",
...
export function getMissionariesAtRisk(): Missionary[] {
  return MISSIONARIES.filter(
    (m) => m.healthStatus === "at_risk" || m.healthStatus === "critical",
  );
}
...
export function getMissionaryFullName(missionary: Missionary): string {
  return (
    missionary.title || `${missionary.firstName} ${missionary.lastName}`.trim()
  );
}
