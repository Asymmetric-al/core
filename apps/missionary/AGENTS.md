...
# Missionary app (`@asym/missionary-app`)
...
- Editing files under `apps/missionary/**`
...
4. Run `bunx turbo run lint typecheck --filter=@asym/missionary-app`.

## Checklist

- [ ] Port 4000 and missionary-only scope respected
