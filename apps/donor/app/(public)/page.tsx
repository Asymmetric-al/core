...
/**
 * The CMS read resolves the tenant from `headers()`, so it cannot join the
 * static shell. Keeping it behind its own boundary lets the hero (the LCP) and
 * every other section prerender and stay instant on soft navigations into `/`.
 */
async function LatestMinistryUpdates() {
