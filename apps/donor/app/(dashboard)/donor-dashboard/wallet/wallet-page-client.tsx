...
const VisualCard = ({
  ...
  return (
    <div
      className={cn(
        "relative rounded-2xl p-6 aspect-[1.586/1] flex flex-col justify-between overflow-hidden shadow-2xl transition-transform duration-300 ease-out border select-none group-hover:scale-[1.02]",
        getBgStyle(),
      )}
    >
