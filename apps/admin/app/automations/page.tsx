      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Orchestrate your ministry workflows and integrations.
          </p>
        </div>
        <div className="flex gap-2">
          <Button
            variant="outline"
            size="sm"
            className="bg-white border-slate-200 text-slate-700 hover:text-slate-900 shadow-sm"
          >
        ...
        <Card className="col-span-4 shadow-sm border-slate-200">
          ...
          <div className="p-3 border-t border-slate-50 bg-slate-50/30 text-center">
            <Button
              variant="ghost"
              size="sm"
              className="text-xs text-slate-500 hover:text-slate-900 w-full h-8 group"
            >
              View All Flows{" "}
          ...
          <CardContent className="space-y-4 p-6">
            {[
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`h-8 w-8 rounded-lg bg-${conn.color}-50 text-${conn.color}-600 flex items-center justify-center border border-${conn.color}-100`}
                  >
            ...
            <Button
              variant="outline"
              className="w-full text-xs font-bold text-slate-600 border-slate-200 h-10 mt-2"
            >
