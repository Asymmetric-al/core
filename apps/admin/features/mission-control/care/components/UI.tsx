...
export const Avatar: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  <div
    data-slot="avatar"
    className={cn(
      "relative flex size-8 shrink-0 overflow-hidden rounded-xl border border-border/50 bg-muted",
      className,
    )}
    {...props}
  >
...
export const AvatarFallback: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  <div
    ...
    className={cn(
      "bg-muted flex size-full items-center justify-center rounded-xl text-xs font-semibold text-muted-foreground uppercase",
      className,
    )}
    {...props}
  >
...
export const TabsContent: React.FC<{
  ...
  return (
    <div
      ...
      className={cn(
        "mt-4 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 animate-in fade-in-0 slide-in-from-top-1 duration-200",
        className,
      )}
      style={style}
    >
...
export const Calendar: React.FC<CalendarProps> = ({
  ...
  return (
    <div
      data-slot="calendar"
      className={cn(
        "p-4 bg-background rounded-2xl border border-border shadow-sm",
        className,
      )}
    >
