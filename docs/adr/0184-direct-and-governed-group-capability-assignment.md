...
retain immutable history while [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) ends active/unread reminder presentation
...
expires. A local item released in time follows [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) and D43 source
...
active/unread contribution under [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) and may retain only its authorized
