...
blocked by [ADR-0028 — SMS transport unavailable](./0028-sms-evidence-governance-transport-unavailable.md).
...
A released in-product item remains governed by [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) and current D43 source
...
a released local item follows [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md)'s withdrawal end rule, while an external
