...
- Tasks Hub owns only the admitted shared-work identity, recipient assignment
  ...
  coordination facts;
- [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) notification presentation remains a distinct recipient-specific
...
[ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) and remain truthful history, but this neither completes nor mutates the
...
remain truthful presentation history under [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) and D43 actionability,
...
- Tasks Hub is not the only D44 attention surface. A new request yields both an
  exact task and required [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) staff in-product item; current-work rerouting
...
- **Make Tasks Hub the only access-request attention mechanism:** rejected
  ...
  platform concerns. D44 requires the [ADR-0027 — notification presentation](./0027-one-notification-presentation-and-engagement-model.md) staff in-product notification;
