...
- Reference validation is a read-time cost, paid once per render and
  amortized by batching and the Phase 5 cache contract ([ADR-0030 — function level tagged caching publish signal](./0030-function-level-tagged-caching-publish-signal.md)).
