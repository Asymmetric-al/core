...
| admin      | `/api/admin/contribution-operations/correction-requests/[requestId]/decision` | Node.js (no `runtime` segment export) | Correction approval decisions               |
...
| admin      | `/api/admin/crm/table-preferences`                                            | Node.js (no `runtime` segment export) | CRM table preferences (pins, view settings) |
| admin      | `/api/admin/crm/table-preferences/tenant-default`                             | Node.js (no `runtime` segment export) | Audited tenant view defaults                |
| admin      | `/api/admin/crm/table-preferences/views`                                      | Node.js (no `runtime` segment export) | Personal named CRM views                    |
| admin      | `/api/admin/crm/table-preferences/views/[viewId]`                             | Node.js (no `runtime` segment export) | Personal named CRM view management          |
