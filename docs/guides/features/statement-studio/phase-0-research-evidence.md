...
| Legal / signing   | `apps/admin/app/(app)/sign/page-client.tsx`; `apps/donor/app/(public)/sign/[token]/page-client.tsx`                                                                                                                     | **Prototype/mock.** The public signer assigns the literal mock signature `John Doe`; no production legal evidence/context owner was found. Legal packets remain HITL and not implementation-ready.                                                                                                                                                       |
