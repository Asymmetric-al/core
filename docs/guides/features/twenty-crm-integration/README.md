# Twenty CRM retirement and historical integration records
...
The [exact former document at `7abd2c11`](https://github.com/Asymmetric-al/core/blob/7abd2c11ffd4ed70c6775c4fd6f51c996e4350dd/docs/guides/features/twenty-crm-integration/README.md)
...
The [May 9 non-production proof](./proofs/2026-05-09-non-production-twenty-proof.md)
remains a dated experiment. It does not prove present production use, authorize
restoring that stack or establish completion of external cleanup.
