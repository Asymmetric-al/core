...
This starts the admin app at `http://localhost:3030` with gitignored Cloud Agent defaults. Replace placeholders in `.env.local` before testing live Supabase data or real auth.
