...
| `NEXT_PUBLIC_EMAIL_STUDIO_LEGACY_UNLAYER_ENABLED`                                                                        | Optional                                       | Schema-only compatibility flag               | `true`                                                     | Ignored by Email Studio; PDF Studio uses its own fallback flag.        |
