...
| Donors and contribution legal-donor identity | Asym Postgres `donors` linked to typed Parties (Phase 7/9); each contribution has the sole frozen legal-donor snapshot on Phase 13 `contribution_headers` | `packages/api` donor/Party services; Phase 13 source acceptance freezes contribution identity | Asym source facts; auth/provider identities never substitute | Proved same-person merges may repair mutable Party references; preserve frozen legal-donor and issued facts, with document successors only through Phase 7/18 owner authority |
...
| Support Hub originals, admitted source records, source relationships, and inbox/work-home facts | Asym Postgres: Phase 26 owns original Support identity, admitted source meaning, source relationships and current handling facts; canonical intake owns receiving occurrences; native CRM retains Party and relationship truth | Qualified shared API Support/inbox commands and canonical intake admission; trusted tenant/actor/source context and current Phase 12 authorization | Each named source owner; a merged reader, provider ID, observed mailbox or CRM match never replaces original identity or grants access | Guarded owner correction, source-preserving merge/Undo or admission recovery; retain original provenance and unresolved evidence rather than rebuilding identity or history from display data |
| Support Hub work, staff assignment, coverage, reminders, priority, and reply-target timing | Asym Postgres: Phase 26 owns current Support work/control and source-qualified timing/coverage facts; shared task and business domains retain their own obligations and outcomes | One guarded Support command boundary for human, bulk, intake and worker effects; shared durable execution executes owner-admitted work | Current owner-qualified work/control generations and actual source evidence; read state, notification engagement and provider callbacks do not independently redefine work | Conditional correction, due-review or source-specific handoff/recovery; preserve accepted obligations and actual history without replaying sends or claiming a completed financial/care action |
| Support Hub private Reply/new-Note drafts, posted internal notes, and own-note corrections | Asym Postgres: Phase 26 owns private draft bundles and terminal state, posted note identity and saved correction revisions; Phase 17 supplies qualified canonical authoring primitives | Current self-owned conditional draft Save/Discard and separate atomic Reply/Note admission; original-author correction command under current source access | Current private owner, purpose, source and revision; ordinary staff/admin access cannot expose another author’s draft or overwrite a newer revision | Reconcile the same durable result, preserve permitted unsaved work and history, or apply source restriction/disposal; posted-note editing stays local until Save and never repeats note publication or mentions |
| Support Hub labels, source memberships, saved views, and personal navigation | Asym Postgres: Phase 26 owns label vocabulary/memberships and Support query semantics; the shared named-view capability owns definitions, audience and personal pin/layout state | Qualified label/membership and shared-view commands with exact source scope; authorized projections evaluate the complete current population | Current source facts and owner-approved definitions; a view, label, pin or cached result is neither membership authority nor a data-access grant | Conditional rename/archive/restore or exact membership correction; rebuild current authorized projections without changing source records, reapplying removed labels or reviving archived pins |
| Support Hub personal read/Follow state, composing cues, and Compact/Full preference | Asym Postgres: Phase 26 owns private reading/Follow semantics and qualified transient composing state; shared personal preferences own persisted tenant/profile Compact/Full choice; Phase 17 owns notification engagement | Current self-authorized source commands, qualified ephemeral sessions and the shared personal-preference command; independent notification-owner actions | Current source coverage and personal intent/revision; one person’s view never clears another’s cue, acknowledges notifications or changes shared work | Reconcile exact personal commands, expire untrusted composing cues and rebuild permitted projections; preserve deliberate unread intent and do not fabricate historical reads, access or message outcomes |
| Support Hub Public Guidance selections and Internal Staff-guide drafts/publications | Phase 23/Payload owns each exact public Page, publication and public destination; Asym Postgres Phase 26 owns Public selections and the separate Internal Staff-guide source, candidate, publication, lifecycle and private search | Public selection commands requalify source-owned eligibility; Support Staff-guide Save/Publish/archive/correction commands reuse qualified canonical authoring primitives | The current public source wins public availability; the current Support publication wins Internal content, subject to source restrictions and current audience authority | Repair or remove an exact Public selection without unpublishing its Page; correct, publish, archive or dispose an Internal guide through Support, never by exposing a CMS draft or inserting Internal guidance into a reply |
| Support Hub feedback policy, opportunities, responses, review, and report projections | Asym Postgres Phase 26 owns policy/candidate/sampling/response/review meaning and exact source cohorts; Phase 3 owns feedback-purpose contactability and opt-out; Phase 17/6 own invitation presentation and communication | Qualified policy, mature-opportunity, protected-response and review commands; source-owned immutable invitation intent uses the existing Phase 17/6 boundary | Exact original opportunity and current owner authority; delivery, rating, review and genuine Support completion remain distinct facts | Recover the original effect without another draw or invitation; apply only qualified privacy/source corrections and review outcomes, and rebuild cohorts without rewriting final ratings/history or clearing an independent opt-out |
| Support Hub Unwanted designations, exact-pair future-mail holds, and held-input review | Asym Postgres: Phase 26 owns current original-source Unwanted designation; canonical intake owns exact receiving-inbox/observed-mailbox hold policy, first-acceptance decision and held occurrence/gates | Separate qualified Mark/Restore, Hold/Stop and single-input Release/Dismiss commands; each rechecks its own current actor, source, gate and policy authority | Current source/work authority and the policy decision fixed at first durable acceptance; current handling inbox or a CRM Party cannot substitute for the actual receiving pair | Restore current work, stop future holding or release one permitted held input independently; preserve backlog, other gates and possible sends; no person ban, consent change, outbound block or automatic hidden-work removal |
| Support Hub attachment meaning, private originals, preview renditions, and source custody | Source owners retain attachment association, meaning, access floor and retention purpose; Phase 29-compatible shared file capabilities own private byte identity, scan/quarantine, rendition mechanics, delivery and copy disposition | Source-qualified attachment commands plus shared private-file/preview preparation and reads; current source authority applies before derivative access and delivery | Exact original source and current privacy/custody controls; a preview is a derivative, never a new original, official document, import or proof of a business fact | Rebuild an eligible rendition under its exact profile or restrict/dispose dependent copies through the shared file owner; preserve original identity and independent custody evidence without extending source lifetime |
...
| ~~Twenty CRM~~ | **Retired (ADR-0001).** No surface may read or write it | No permitted runtime path; native CRM replacement/removal merged in PR #1325 | Asym Postgres remains the only CRM authority; possible external remnants grant no authority | Runtime removal is complete; exact external variable/key/workspace cleanup remains unverified in `complete-twenty-crm-retirement/tasks.md` |
...
The July 6 retirement decision and later accepted implementation are reflected
in these current sources. Historical capture records retain their original
wording and are not instructions to restore a vendor runtime.

- **Program contracts:** this matrix, the charter, parity matrix and phase map
  route CRM truth to Asym Postgres. Phase 4's claim/merge source and Phase 7/9's
  Party spine retain their respective owners. The Phase 8 re-groom (#603) was
  ratified July 7: its observability/data-health core has no hard prerequisite,
  while Phase 6/9 gate the named communication and graph-health seams.
- **OpenSpec:** the withdrawn proposal is already stored at
  `openspec/changes/archive/2026-07-02-integrate-twenty-crm-core/`; its retired
  vendor deltas must never be applied. The formerly stale durable `crm-core`
  contract did still prescribe Twenty after retirement. AL-1861 synchronizes
  it to the accepted native CRM/retirement contract; the claim that no
  durable-spec correction was required was incorrect.
- **Runtime:** PR #1325 merged the native notes/relationships replacement and
  Twenty runtime-removal/guard stack into `develop` on August 19 at
  `7abd2c11ffd4ed70c6775c4fd6f51c996e4350dd`. Notes read/write local
  `crm_notes`; relationships query local Asym sources. The data-boundary guard
  rejects restoration of Twenty clients and retired environment fields.
- **Guides:** `docs/guides/features/twenty-crm-integration/**` and
  `docs/guides/operations/twenty-crm-cutover.md` are historical/retired material,
  not active deployment, rollback or integration instructions. Current CRM
  implementation follows `openspec/specs/crm-core/spec.md`, ADR-0001 and the
  Asym-owned source boundary; a historical status banner does not make old
  vendor setup steps executable.
- **Glossary and Phase 8:** root `CONTEXT.md` and the re-groomed Phase 8 PRD
  define observability, escalation and data health over Asym sources. The
  old CRM write gate, vendor health proof and provider cutover are withdrawn,
  not work pending another re-groom.
- **GitHub chronology:** July 6 issue re-scoping and July 7 re-groom records
  explain how #587/#588–#601 and #602/#603 evolved. They are dated publication
  evidence, not a live issue-status dashboard or proof that Phase 8's new
  operations surface has been implemented.

## Retirement execution and remaining external cleanup

The original #602 inventory named Twenty clients, gateway/health/schema probes,
webhooks, projections, sync/reconciliation and vendor-backed notes/relationships
for removal or native replacement. That **runtime work is integrated through
PR #1325**. Do not repeat it by deleting reusable CRM capability or recreate
old provider modules to satisfy the historical inventory.

Reusable Asym-owned boundaries remain, including `crm/auth/access.ts`,
`crm/commands/log.ts`, local notes/relationships services and duplicate/
normalization helpers. Retained schema/comments/provider identifiers are
migration or compatibility evidence only; any later change follows their
source-owned migration and retention rules. Archive history is already present
at the exact path above. The August merge does not prove hosted migration,
external service disposal or credential revocation.

**Still unverified:** inventory and remove any remaining Vercel `TWENTY_*` /
retired `CRM_SYNC_*` settings, revoke the old Twenty development credential and
resolve the proof workspace/records under authorized access. The exact remaining
blocker and evidence live in
`openspec/changes/complete-twenty-crm-retirement/tasks.md`. Never print secrets,
claim no external copy exists, or report this cleanup complete from a code merge.

## Open items

1. **External cleanup proof:** resolve the Lane 2 Vercel discrepancy and the
   remaining credential/workspace disposition with exact current evidence.
2. **Phase 8 implementation acceptance:** the July 7 re-groom is settled, but
   its new operations/data-health contracts still need their own source, test
   and deployment evidence. Re-groom completion is not product completion.
3. **Current issue status:** consult the tracker when dispatching; preserve
   the July issue-re-scoping history without treating it as current labels or
   an authorization to resume withdrawn vendor work.
...
## Dated Phase 25 donor self-service ownership extension (2026-09-09)

The [Phase 25 specification](./phase-25-donor-dashboard-depth.md) and
[Shared S04](./phase-25-donor-dashboard-depth/contracts/shared.md#s04--exact-owner-amendment-and-predecessor-reconciliation-register)
add the following exact-purpose extensions under the existing owners. This
implements the phase-map standing rule that a phase introducing record types
extends this matrix in the same planning change. These are ratified intended
contracts and proposed source-owner amendments, not a claim that their records,
write paths or qualifications already exist in runtime.

The type column distinguishes new bounded logical records from reuse of an
existing owner family. A surface projection, catalog entry or source amendment
does not create a second source of truth. All writes remain authorized canonical
owner commands through `packages/api`; P12 remains the sole fine-grained PDP.
Provider evidence establishes only the exact provider effect, and immutable
source history is never repaired by editing a portal summary.

<!-- prettier-ignore -->
| Record type / extension | System of record | Write path | Conflict winner | Repair path |
| --- | --- | --- | --- | --- |
| **New-gift preference head and pending intent** — new bounded records in the P13 giving/checkout owner ([RC13-RC15](./phase-25-donor-dashboard-depth/contracts/recurring.md#rc13--first-save-access-and-new-gift-preference-scopedefault)) | Asym Postgres P13, scoped by stable actor, giving Party, Tenant, Legal Entity and qualified settlement/account/mode/Customer binding. P16 retains recurring use, authorization and the shared new-use/removal fence. | P13 explicit set/reaffirm/Clear and accepted-intent readiness/reconciliation commands; same-scope atomic head, intent revision and result. Standalone setup remains the exact P13 Customer/setup path. | Current source intent revision and exact still-valid readiness/deadline, never browser time, webhook arrival, provider Customer default or another actor's preference. | Reconcile the same accepted intent; preserve independently saved methods; clear only the exact removed effective/pending reference and retain newer choices. Expired/failed intent never resurrects a predecessor. Only proved same-Party reference repair may preserve meaning. |
| **Personal mailing binding, immutable value revisions, use generations, withdrawal and scoped result evidence** — new personal-mailing aggregate within P9 contact ([IC11-IC14](./phase-25-donor-dashboard-depth/contracts/identity.md#ic11--one-optional-mailing-address-and-international-editor)) | Asym Postgres P9, one Tenant/person-Party/purpose current binding and a monotonic guard surviving Clear. Phase 19 separately owns frozen destination and fulfillment evidence. | P9 contact transaction co-commits successor/Clear, required generation withdrawal, result, CRM audit/activity and downstream event; expected revision and scoped nonce bind actor/payload. | Current P9 revision/use guard wins new mailing admission; a crossed or unknown fulfillment handoff remains Phase 19's actual evidence. Auth metadata, Party blobs, legal/billing/represented addresses are not fallbacks. | Append authorized value/Clear successors; exact retry returns its original effect plus current admitted revision. Hold unadmitted withdrawn uses and reconcile crossed/unknown handoffs; no automatic retarget, recall promise, guard reset or deleted-identity cascade. Apply IC14 custody limits. |
| **Guided email-change request and per-use progress** — bounded intent/progress extension of shared identity and P9 contact ([IC06-IC09](./phase-25-donor-dashboard-depth/contracts/identity.md#ic06--selected-related-email-changes-and-stable-claim-proof)) | Asym retains accepted two-use request intent, trusted scope, revisions and correlations; Supabase Auth remains sign-in credential truth, P9 remains organization-contact truth, and the identity owner retains established claim proof. | Shared identity/contact workflow records accepted selected uses before effects, then invokes each separately authorized owner command and records its durable result. | Each owner wins its own value, proof and current revision; request progress never substitutes for email truth or transfers a claim. | Reconcile only unfinished original steps and preserve independent successes; supersede only through qualified current owner rules. Unknown provider effects never justify fresh-key repeats, fictional rollback, stale contact overwrite or a generic CRM journal. |
| **Newsletter Form Submission Occurrence, frozen route/recipient snapshot and Primary Outcome** — P23 D26 existing record family with a new request-only profile ([EX11-EX13](./phase-25-donor-dashboard-depth/contracts/experience.md#ex12--one-newsletter-owner-two-governed-independent-steps)) | P23 D26 source owns the immutable occurrence, purpose/schema/released Route Plan and operational Primary Outcome; no CRM prospect, external subscription or donor notification store is created. | The qualified P23 submission boundary atomically accepts occurrence, route, snapshot, Primary work, required local child and identifier-only dispatch requests before Request received. | Frozen accepted source/route identity wins occurrence meaning; current source/recipient/safety fences still govern each unstarted effect. P6 alone proves transport acceptance. | Resume the same committed occurrence and qualified residual work through the existing outbox/dispatch recovery. Preserve successful children and reconcile indeterminate effects; no visitor resubmission, historical retarget or enrollment inference. P22-P24 prerequisites must be finally accepted and qualified before this consumer is dispatched. |
| **Newsletter request received catalog generation and communication plans, slots and prepared outcomes** — new P17 semantic purpose using existing P6 records ([EX12-EX13](./phase-25-donor-dashboard-depth/contracts/experience.md#ex12--one-newsletter-owner-two-governed-independent-steps)) | P17 owns the finite semantic contract/activation generation and two required steps; P6 owns plans/slots, dispatch claims/fences, preparation, sealed envelopes and normalized body-free evidence. P23 retains source eligibility and occurrence. | Qualified P17 preparation and the single P6 send/dispatch seam under the frozen complete plan; provider callbacks are validated against trusted route and sealed identity. | Source applicability and current safety win effect admission; conclusive P6 transport acceptance wins only the exact frozen member's handoff result. Local notice availability proves no email or enrollment. | Recover only qualified residual members without repeating successes or issuing a new key after indeterminate send. Enforce the original seven-day first-effect and thirty-day body-access limits, source stops and P6 disposal; no provider-template/direct-send bypass or clock reset. |
| **Donor notification catalog admission, local presentations, groups and human engagement** — extension of existing P6/P17 occurrence/presentation records, not a new donor store ([EX08-EX09](./phase-25-donor-dashboard-depth/contracts/experience.md#ex08--finite-donor-notification-catalog)) | Asym P17 semantic catalog, local presentation/grouping/engagement with existing P6 occurrence/plan evidence; each producer retains its financial/document/action source and source-end truth. | Qualified owner event-to-local-availability path plus narrow canonical read/archive/restore and accepted-cutoff engagement commands, scoped to human/Tenant/role/surface/giving context. | Current source end, revocation and child availability identity win over stale engagement; one human's read is not another's, and read never completes the source action. | Rebuild only compatible groups from independent child evidence; reconcile the same accepted cutoff/revision. Preserve later children and original lifetimes; no replay-driven unread restoration, revived access, GET repair write or duplicate producer effect. |
| **Giving-history export preparation request/result and exact private artifact metadata** — new narrow P3 export record using existing execution/storage ([D09-D11](./phase-25-donor-dashboard-depth/contracts/financial.md#d10--durable-bounded-export-and-exact-file-access)) | Asym Postgres P3 owns reviewed scope, semantic identity, state/revision, coherent extraction proof, artifact identity and original deadlines; source owners retain money and P12 governs current field/egress admission. Private storage holds exact bytes only. | P3 reviewed admission and existing worker/outbox/claim path atomically/fencedly publish Ready only after snapshot, completeness, hash/size/count, current authority, cancellation and deadline proof. | Frozen admitted scope and exact source snapshot win file meaning; current relevant access contraction invalidates the whole file. Upload, browser download or object URL is not Ready/authority. | Reconcile the same request/object and original deadlines; keep orphan/unknown objects private. Retry exact authorized bytes, dispose terminal payload under D10, and require a new deliberate review after terminal work; never rewrite source money, silently truncate or revive a terminal request. |
| **IRA-origin facts, QCD intent/evidence and acknowledgment case admission** — typed P7/P13 source extension ([D16-D17](./phase-25-donor-dashboard-depth/contracts/financial.md#d16--iraqcd-source-case-distinct-from-daf-and-tender)) | P13 retains received contribution, contributor/custodian and money/date provenance; P7 owns current source-qualified document-case/purpose admission and approved facts. P18 retains exact artifact/current-head truth. | Authorized P7/P13 source commands alone record facts and admit/supersede the same-Tenant contribution/issuer/contributor/evidence-revision case; P18 consumes only qualified facts. | Each owner wins its fact; received money remains true independently of unresolved or dark document qualification. Recorded intent is neither a deductible boolean nor personal tax certification. | Correct source evidence with audit/outbox and append an approved case/facts successor; invalidate affected eligibility/projections/documents without changing money to fit them. No guessed QCD classification, ordinary-receipt fallback or donor-edited tax outcome. |
| **DAF-advisor and own-employee matching private read purposes/projections** — extensions of P14 recognition/matching and P12/P3 admission, not new ledgers or automatic access grants ([D13-D15](./phase-25-donor-dashboard-depth/contracts/financial.md#d15--received-daf-grants-awareness-with-exact-attribution)) | P14 retains source attribution, recognition, match state/settlement basis and approved correction/identity lineage; P12/P3 retain current subject/field/purpose admission. The read model is subordinate. | Existing authorized P14 source corrections/import/merge commands supply coherent projections; reading never writes a credit, money, awareness fact or document. | Current independently admitted attribution and source money/state basis win; household/shared email/provider identity and optional Support overview do not grant or veto the exact independent read. | Rebuild coherent views from current canonical sources and grants, preserving source roots/corrections. Wrong attribution or revoked rights removes access without deleting money; no inferred grant remainder, sponsor/coworker access, personal-giving/CSV inclusion or automatic duplicate deduction. |
| **Fixed-total pledge change-request/protective-dispute occurrences and receiving work** — new closed occurrence kinds in existing P16 pledge services ([RC24](./phase-25-donor-dashboard-depth/contracts/recurring.md#rc24--fixed-request-protective-dispute-and-reminder-stop)) | Asym Postgres P16 owns immutable request/dispute scope, input/revisions, receipt, receiving work and source-confirmed disposition; P13/15 remain the only money writers. | Qualified P16 intake atomically accepts the typed occurrence and actionable/discoverable receiving work. Explicit protective intake uses the existing authority-review state; separately authorized staff commands own actual terms. | Current P16 source authority/revision and proved receiving disposition win; ordinary request, read, timer and provider callback cannot approve terms, execute money or mark completion. | Reconcile same-operation input/result, preserve immutable text and independently linked current terms, and append source-proved disposition. Enforce ninety-day raw-text custody without faking completion; no NLP-derived dispute, automatic refund/recurring stop or generic request executor. |
| **Routine recurring receipt-email preference and not-requested occurrence decision** — exact-purpose P7 source extension consumed by P17/P6 ([D08](./phase-25-donor-dashboard-depth/contracts/financial.md#d08--eligible-routine-recurring-receipt-quieting)) | Asym P7 owns the Tenant/legal-issuer/receipt-owning-donor/purpose choice and pre-occurrence not-requested decision; P17 owns admitted message meaning and P6 retains purpose-qualified send-time safety/evidence. | Authorized P7 preference transaction co-commits explicit value, revision, result and audit with durable ordering against routine-occurrence admission, including absent-row races. | P7 admission ordering wins: Off before admission prevents only a new eligible routine occurrence; an already admitted required lifecycle remains authoritative. Marketing opt-out or provider suppression is not this choice. | Reconcile same-operation result/current revision; a fresh authorized Off fences uncertain older On. Preserve required facts/documents and existing admitted work; no backlog on On, provider-unsuppression, test receipt, universal consent flag or read-based legal-delivery claim. |
| **Guest-origin newsletter recipient projection and current access** — bounded P28 workspace/P12 authorization extension, not a new donor, follower or request record ([EX12/EX16](./phase-25-donor-dashboard-depth/contracts/experience.md#ex12--one-newsletter-owner-two-governed-independent-steps)) | P23 retains the immutable request occurrence/payload and frozen intended recipient; P28 owns only its narrow missionary-workspace projection and P12 remains current exact recipient/field/purpose authorization. P17 retains Information engagement. | Qualified P28 source-backed reads intersect the frozen human recipient with current same-Page/typed-subject/purpose authority and safety. Request writes remain P23; Read/Archive remain the existing engagement command, not an enrollment or completion writer. | Current P12/source/custody admission wins over old assignment, matching email, generic missionary/Page-editor role or frozen recipient identity alone. Guest origin requires no fabricated supporter edge. | Reproject only currently retained/admitted source data, remove access on revocation/expiry and preserve exact narrowly authorized repair. Never transfer old bodies to a new assignee/spouse, restore expired detail, widen CRM access or create a second request store. The bounded P28/P12 contract and proof precede Q25 dispatch; full Phase 28 remains future work. |
| **Newsletter-request exclusion from external enrollment, consent and integration/export admission** — bounded P32 owner-boundary extension; Q25 creates no external subscriber record ([EX11/EX16](./phase-25-donor-dashboard-depth/contracts/experience.md#ex11--newsletter-request-input-and-durable-visitor-result)) | The missionary's actual external newsletter system owns subscription state; P32 retains any separately governed future integration/consent/export boundary. P23/P17/P6 own only the request and their stated handoff/presentation evidence. | Q25 provides no external contact/list insertion, subscribe/resubscribe, suppression reset or enrollment-authorizing export. Request acceptance, delivery, Read/Archive/Copy and retries cannot qualify such a writer; a future external action needs its independent owner authority. | Actual external subscription and independently qualified consent/integration facts win; requested email, request proof, handoff or engagement is not enrollment or consent evidence. | Preserve the exclusion through replay and later owner adoption. Route any unintended external effect to the independently authorized integration/consent repair path; never infer enrollment, issue a blind inverse or resubmit the visitor request. Accept and prove this narrow boundary before Q25 dispatch without implementing or grooming the entire Phase 32 sync product. |

The narrower Phase 25 entries clarify only their declared purposes within the
existing matrix rows and dated P17/P19 amendments. They do not transfer Supabase
credential truth, P13/15 money, P16 recurring authority, P18 artifacts, P19
fulfillment or P6 provider evidence to the donor surface. P22-P24 proposal
references are not merged authority or dispatch readiness; the exact producer
must be finally accepted and qualified before its dependent consumer work.

## Dated Phase 26 Support Hub ownership amendment (2026-09-16)

The rows above record the fully ratified [Phase 26 Support Hub contract](./phase-26-support-hub-conversation-management.md), including G01–G15 and D1–D40; they do not claim implementation. Support Hub handles ordinary requests as one Asym surface. Its staff assignments and coverage are distinct from the existing **Phase 21 Support Assignments** and financial workspace contracts, which remain unchanged. Native CRM, giving, care and task owners retain their own facts, approvals, permissions and correction commands. Linking or resolving Support work does not complete those actions.

Phase 17/Email Studio retains governed reusable wording, canonical authoring/schema, presentation and complete immutable preparation; Phase 6 retains actual communication intent, recipient/channel evidence, dispatch and reconciliation. Internal Staff-guide publication belongs to Support, not CMS or Email Studio publication. A Note is not an outgoing email preparation; independently authorized post-derived attention retains its separate Phase 17/6 boundary. Public Page guidance and contact-form dependencies remain with their Phase 23 source. No second CRM, provider account authority, transcript owner or workflow/rules platform is introduced.

Phase 26 source qualification does not create another file store or preference authority. Shared Phase 29-compatible byte/custody and preview primitives enforce the source’s current access and lifetime; shared personal preferences persist the Compact/Full choice. Combined readers, search, overview counts and CRM panels are currently authorized projections, not write authorities. Repairs preserve original identities, conditional command results, source restrictions and independently admitted effects; archived or expired material and possibly submitted communication cannot be recreated merely to make a projection appear complete.
