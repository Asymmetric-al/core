...
| Travel Allowance Capacity Key Contracts, Opening Cumulative States, Cumulative Admission Manifests, first-use admissions, and affected-suffix corrections                           | Each external source owns its predecessor activity and prospective-completeness facts; Phase 21 D18/D28 owns the versioned Capacity Key Contract, opening/continuity admission semantics, complete manifest, group-atomic first use, and append-only correction coverage; D27 owns only a reference to current proof                                                                                                                                                                                                                                                   | One source-authorized clean-boundary, exact opening-state, or external-at-boundary disposition plus one prospective-completeness disposition enters the D18/D28 admission command; D18 alone performs any later native calculation and Phase 30 may transport only selected bulk preparation             | Source evidence wins its source facts; D18/D28 wins native-admission and calculation truth; D27 cannot recreate, waive, or reinterpret the proof                                                                                              | Append one exact Opening Cumulative State correction and recompute only the affected suffix or indivisible group; missing never becomes zero, uncertain scope remains on D18's external-calculation lane, and no admission fact creates claim, approval, Field Account, payment, payroll/tax, or accounting truth                                                                                   |
