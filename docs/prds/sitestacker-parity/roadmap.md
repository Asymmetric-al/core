...
| **23** | `web-studio-cms`             | [CMS / Site Planner Dynamic Content Parity](./phase-23-web-studio-cms.md)                                                         | **2, 3, 5**                                           | 22                                                    | Web Studio, Payload, Public Website                             | `PRD exists` (implementation-ready 2026-08-24; spec [#1339](https://github.com/Asymmetric-al/core/issues/1339); [OpenSpec](../../../openspec/changes/add-web-studio-cms/proposal.md); D1–D36 scope-frozen; not implemented; hard implementation deps are 2/3/5; Phase 10/12/22 are documented consumer contracts, not merge gates; Phase 22 PRD is still open as [#1323](https://github.com/Asymmetric-al/core/pull/1323) and remains `future (needs PRD)` in this table)                                                                                                                                                |
...
- **Phase 17 (System Messages)** needs only 6 + 2 + 3 + 7 — it can run alongside
  either chain.
- **Phase 23 (Web Studio/CMS)** needs only **2 + 3 + 5** — it can start
  early whenever content-lane capacity exists. Phase 10, 12, and 22 remain
  documented consumer/safety contracts, not implementation merge gates. Phase
  22's PRD is still open ([#1323](https://github.com/Asymmetric-al/core/pull/1323));
  this Phase 23 spec does not wait on that merge.
