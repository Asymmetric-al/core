...
| **22** | `public-ministry-pages` | Public Missionary & Project Page Workflow | 5, 9, 10, 13, 3 | 15, 16 (offline gifts + commitments in progress bars) | Web Studio, Public Website, Missionary Workspace, Contributions | `PRD exists` (proposed [PR #1323](https://github.com/Asymmetric-al/core/pull/1323); unmerged; affected P25 consumers not dispatch-ready) |
| **23** | `web-studio-cms` | CMS / Site Planner Dynamic Content Parity | 5, 3, 2 | 22 | Web Studio, Payload, Public Website | `PRD exists` (proposed [PR #1340](https://github.com/Asymmetric-al/core/pull/1340); unmerged; affected P25 consumers not dispatch-ready) |
| **24** | `multi-site-management` | Full Multi-Site, Language & Currency Management | 2, 5, 13, 20, 23 | 17 | Tenant settings, Web Studio, Contributions settings | `PRD exists` (proposed [PR #1558](https://github.com/Asymmetric-al/core/pull/1558); unmerged; affected P25 consumers not dispatch-ready) |
