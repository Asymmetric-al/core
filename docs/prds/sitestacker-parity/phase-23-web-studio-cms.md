...
owners. Hard implementation dependencies are Phase 2's Site/Locale/Currency
Foundation, Phase 3's Minimum Permission and Role-Scoped Projection Foundation,
and Phase 5's public runtime. Phase 10 eligibility, Phase 12 capabilities and
the founder-ratified Phase 22 contracts are required at their affected
consumer/safety seams; they are not blanket merge gates for the ordinary
Phase 23 core. An affected integration stays unavailable until its owning
contract and implementation qualify.

This adopts the September 16 clarification in source PR #1340 at
`db7a5e519ee062d28d05f68e5f8aff707de6e209`. The original Phase 22 PR #1323
remains open at this snapshot; AL-1861 has adopted its planning contract
alongside Phase 23. Neither source-PR merge state nor documentation adoption
proves producer implementation.
