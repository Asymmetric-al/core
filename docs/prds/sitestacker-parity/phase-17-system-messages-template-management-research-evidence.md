...
| `packages/api/src/giving/receipts.ts`                                                           | successful and updated/replacement receipt calls plus `email_send_logs` persistence                | migrate to `giving_receipt_issued_v1`, `giving_receipt_replaced_v1`, and the exact correction producer mapping; Phase 7 source facts/issuance effects and Phase 18 exact artifact/currentness remain authoritative |
