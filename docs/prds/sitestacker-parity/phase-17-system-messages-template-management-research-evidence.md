...
12. **INFERRED:** Transactional, subscribed, and marketing purposes must remain explicit. RFC 8058 unsubscribe is a separate POST contract; ordinary protected actions retain D6's scanner-safe non-mutating GET followed by an Asym confirmation.
...
## 5. Deliverability, classification, and scanner-safe actions
