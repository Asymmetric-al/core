...
> **⚠️ SUPERSEDED — do not build from this file.** This groomed-but-unbuilt PRD is superseded by **Phase 8 — CRM Operating Foundation** ([`phase-08-crm-operating-foundation.md`](./phase-08-crm-operating-foundation.md)), which carries the same operating-foundation goals **plus** the write-enable + operations work this file reserved for "Phase 8+" (the Twenty write-enable tranche since withdrawn by ADR-0001 — see the scope note below). Retained for history only — build from the Phase 8 PRD once its ADR-0001 re-groom lands (its own banner currently says do-not-build).
...
> **Tracking note (2026-07-06):** the tracking issues below (#466–#476) were closed as superseded (ADR-0001); surviving operating-foundation work is tracked under Phase 8 epic #587, pending the re-groom (#603).
