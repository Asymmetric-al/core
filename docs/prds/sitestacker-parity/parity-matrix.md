...
- **Current state:** Asym Postgres is the CRM system of record
  ...
  The earlier Twenty CRM integration and its runtime were removed through
  merged PR #1325 on 2026-08-19. CRM grid/detail screens, notes and relationships
  use native Asym Postgres services. External provider/credential cleanup proof
  is tracked separately from that completed repository removal. The **operating foundation**
  ...
  write-enable spine removed; observability + escalation over the
...
- **Evidence:** `docs/ops/phase-evidence/2026-05-14_phase-04_twenty-crm-foundation.md`;
  the [current crm-core specification](../../../openspec/specs/crm-core/spec.md)
  and merged PR #1325. The May evidence is historical.
...
- **Evidence:** identity-and-access specification (PR #462 merged 2026-07-09);
...
- **PRD:** the adopted [Phase 23 contract](./phase-23-web-studio-cms.md)
  fixes D1–D36, including semantic content families, governed dynamic sources
  and coherent Site generations. Source PR #1340 remains open at this snapshot.
- **Open questions:** none at the Phase 23 product-contract level; actual
  provider, migration, accessibility, capacity and runtime qualification remains.
...
- **PRD:** the adopted [Phase 24 specification](./phase-24-multi-site-management.md)
  fixes the ordinary product scope and owner seams; source PR #1558 remains
  open at this snapshot. Its exact declaration of D56's later owner boundary
  remains in force.
- **Depends on:** the qualified Phase 2/5/13/20/23 owner seams specified by the
  Phase 24 contract, rather than parity-area number 13 alone.
- **Acceptance test:** a tenant operates the exact qualified Site/domain/locale
  and giving-currency journeys without crossing identity, financial or
  publication authority.
- **Evidence:** the Phase 24 decision log, traceability and implementation
  proof plan distinguish adopted requirements from unexecuted runtime proof.
- **Open questions:** ordinary scope is ratified; provider/capacity evidence
  and the explicitly reserved owner-boundary work remain separate.
...
- **PRD:** the complete
  ...
  source/qualification gates. AL-1861 adopts its bounded owner amendments
  with the Phase 22–24 predecessor contracts. The verified 2026-09-16 delivery
  graph has 88 native implementation issues #1565–#1652 under #1563; the graph
  and adopted planning do not prove feature implementation.
- **Depends on:** the source-owner and predecessor adoption register in
  ...
  The reconciled P22–P24 contracts are adopted planning; their required
  producer implementations must qualify before affected consumers activate.
