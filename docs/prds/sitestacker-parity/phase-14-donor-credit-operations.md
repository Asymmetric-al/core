...
**Pending physical-state decision (C-02, 2026-09-23).** The contribution-header
placement below conflicts with Phase 13's whole-posted-row immutability. The
logical acknowledgment lifecycle, audience, coverage and Phase 6 outcome join
remain accepted; this column placement is not permission to update a posted
money row. Read the [owner decision record](../../ai/audits/2026-09-23-contract-congruence.md#c-02-posted-state)
and wait for the founder's separate-records versus narrow-exception ruling
before implementing that storage seam. No acknowledgment transition may
silently bypass the money owner's trigger or rewrite frozen facts.
