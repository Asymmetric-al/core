...
- **Phase 8 (CRM Operating Foundation)** was **re-groomed 2026-07-07 (#603
  ...
  write-enable spine was withdrawn and its runtime was removed in merged
  PR #1325 (2026-08-19); the phase is
...
- [`phase-08-crm-operating-foundation.md`](./phase-08-crm-operating-foundation.md)
  ...
  withdrawn; runtime removal merged through #1325 on 2026-08-19. The
  build-now core has no hard prerequisite; Phase 6/9
...
- [`phase-25-donor-dashboard-depth.md`](./phase-25-donor-dashboard-depth.md)
  ...
  AL-1861 adopts the scoped source-owner amendments together with the Phase
  22–24 predecessor contracts. Their implementations and qualified producer
  seams remain prerequisites for affected consumer activation.
  G01's supported native Auth linking guarantee remains unresolved and blocks
  affected social activation. The live 2026-09-16 graph contains 88 native implementation issues
  #1565–#1652 under #1563. This documentation adoption implements no feature
  and certifies no runtime or provider qualification.
...
- [`phase-26-support-hub-conversation-management.md`](./phase-26-support-hub-conversation-management.md)
  ...
  D27-C and D29-X01; the live 2026-09-16 delivery graph has four native
  index issues #1658–#1661 and 199 leaves #1662–#1860 under #1656.
...
OpenSpec PR [#462](https://github.com/Asymmetric-al/core/pull/462) merged on
2026-07-09. It refined platform intent and capability specifications, including
donation lifecycle, CRM, contribution operations, identity/access and workflow
orchestration. Its active donor-money-path changes remain planning until their
implementation is accepted; the parity program extends those existing owners
without creating competing domains.
