...
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| Card `succeeded`          | Activate accepted schedule after binding/reconciliation                                                                                   | Success + next scheduled gift                               | Post once; zero-or-one Phase 7 authorization according to the frozen plan/applicable policy |
...
| ACH `succeeded`           | Establish bank collection lineage and activate future executor when all controls pass                                                     | Success + next scheduled gift                               | Post once; zero-or-one Phase 7 authorization according to the frozen plan/applicable policy |
...
| `pending_activation`              | provider-confirmed success + reconciled binding                       | `ongoing`                                     | Create/post source once, emit Phase 7 authorization pointer, activate future executor                            |
...
| Processing                                                                      | confirmed success                          | success; create/post source once and emit zero-or-one Phase 7 authorization pointer according to the frozen plan/applicable policy |
...
| REC-16 | ACH late return appends exactly one Phase 13 money inverse and one Phase 7 correction pointer, then Phase 18/19/17 resolve their independent artifact, statement, and delivery outcomes; processing never counts received or creates downstream official work.                                                              |
