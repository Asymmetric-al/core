...
`source-owned immutable facts / optional issuance -> immutable document publication -> idempotent generation request -> subordinate fenced attempts -> exact verified private PDF -> Phase 17 governed content -> separately linked Phase 6 delivery`
...
| `delivery_policy`          | Permitted Phase 17 content and Phase 6 intent/dispatch handoff routes; delivery never changes issuance/artifact truth.                                                                                                    |
...
| Delivery and communication event       | Phase 6, with Phase 17 governed content                        | Phase 18 hands off exact artifact identity; cannot send or infer delivery/read                                                                                         |
