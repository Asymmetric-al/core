...
| **22** | Public Missionary & Project Page Workflow | 5, 9, 10, 13, 3 | `PRD exists` (proposed [PR #1323](https://github.com/Asymmetric-al/core/pull/1323); unmerged; affected P25 consumers not dispatch-ready) |
| **23** | CMS / Site Planner Dynamic Content Parity | 5, 3, 2 | `PRD exists` (proposed [PR #1340](https://github.com/Asymmetric-al/core/pull/1340); unmerged; affected P25 consumers not dispatch-ready) |
| **24** | Full Multi-Site, Language & Currency Management | 2, 5, 13, 20, 23 | `PRD exists` (proposed [PR #1558](https://github.com/Asymmetric-al/core/pull/1558); unmerged; affected P25 consumers not dispatch-ready) |
| **25** | [Donor Dashboard Depth](./phase-25-donor-dashboard-depth.md) | Baseline/start: 3, 4, 6, 7, 13.<br>Before affected consumer dispatch: exact P9, P10, P12, P14, P16, P17, P18, P19 and P22–24 producers from S04/S06 require final accepted contracts plus implemented, qualified owner seams. Q25 also requires the bounded P28/P12 guest-recipient projection and P32 external-enrollment exclusion before dispatch; neither whole future phase is a prerequisite. P22–24-dependent and Q25 consumers remain not dispatch-ready until their exact producer gates pass. Unaffected safe slices remain independent. | `PRD exists` (spec #1563; Q01–Q29 ratified, Q30 accepted; scoped source-owner prerequisites; not implemented; no child-ticket graph or blanket dispatch readiness) |
...
| **28** | Missionary Workspace Depth & Support-Raising CRM | 9, 13, 16, 6, 3, 27 | `future (needs PRD)` for the full phase; unimplemented. [Q25 only](./phase-25-donor-dashboard-depth/contracts/experience.md#ex16--qualification-rollout-and-retained-proof) defines a proposed P28/P12 guest-origin newsletter-recipient projection; not general Phase 28 readiness. |
...
| **32** | Mailchimp / Newsletter Sync with Suppression Handling | 6, 3, 28, 4, 31 | `future (needs PRD)` for the full phase; unimplemented. [Q25 only](./phase-25-donor-dashboard-depth/contracts/experience.md#ex16--qualification-rollout-and-retained-proof) defines a proposed P32 external-enrollment exclusion; no newsletter-sync implementation or general Phase 32 readiness. |
...
- **Do not present any later phase (9–40) as implemented or live.** Groomed
  ...
  proposed source-owner amendments and per-capability producer prerequisites
  stated in its dependency cell and Shared S04-S06; no feature implementation
  or child-ticket graph is claimed. P22-P24 consumer implementation is not
  ...
  Published
  issue posture is not build proof, and only an explicit founder decision may
