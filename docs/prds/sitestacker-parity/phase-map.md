...
- **Phase 8 re-groom is pending.** ADR-0001 withdrew Phase 8's Twenty
  ...
  re-groomed against Asym-internal subjects in a dedicated session before any
  Phase 8 build starts; the Phase 8 PRD carries a scope-amendment banner until
  the re-groomed PRD lands.
...
- **Do not present any later phase (9–33) as implemented or live.** No PRD
