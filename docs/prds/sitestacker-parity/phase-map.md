...
- **Do not present any later phase (9–40) as implemented or live.** Groomed
  ...
  persistent Shadscan report are the final machine-check evidence once green.
  The assessed planning baseline is 29/100 against the configured floor of 29
  using `bunx @shadscan/cli@0.1.1 ./packages/ui --json --no-interactive`; no UI
  path changes in this PR. Only an explicit
  founder decision may
