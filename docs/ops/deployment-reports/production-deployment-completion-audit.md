...
| Ensure `main` contains the current `epic` lineage before production      | `git rev-list --left-right --count origin/main...origin/epic` reports `1 916`; `main` is stale relative to `epic`.                                                                                                                                                                                                      | Blocked  |
