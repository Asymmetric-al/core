...
- **Mobile-web native-feel only:** `docs/ai/skills/mobile-native/SKILL.md`; explicit-only for viewport, touch, safe-area, and PWA tells. Keep `disable-model-invocation: true`. Do not auto-route ordinary Core frontend work through it.
