...
**Note:** Nia (MCP) searches must remain repo-scoped to `Asymmetric-al/core` and include the required preamble from `docs/ai/working-set.md` + `docs/ai/stack-registry.md` (see `docs/ai/nia.md` and `AGENTS.md#nia-mcp-usage-always-repo-scoped`).
