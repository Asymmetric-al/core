...
source_path: skills/better-colors/
...
# Upstream: better-colors

Canonical copy in this repo: `docs/ai/skills/better-colors/`, mirrored to
...
1. Refresh the lockfile-managed skill with a targeted Skills CLI add:
   `npx skills add jakubkrehel/skills --skill better-colors -y`.
