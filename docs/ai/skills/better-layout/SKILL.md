...
Layout spacing and grouping follow Core density and
`packages/ui` primitives, not a parallel spacing scale.
...
- Reviewing grouping, alignment, spacing, or spatial RTL.
- Do not rebuild product layouts from a generic marketing-page grid.

### Workflow

1. Reuse existing layout primitives and spacing tokens.
2. Keep `base-maia` and Base UI composition.
3. Do not restyle Core product apps to chase a new layout language.

### Checklist

- [ ] Core density and primitives were preserved.
- [ ] Upstream spacing literals did not fork the design system.
