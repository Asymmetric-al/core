...
source_path: skills/animate-expo/
...
# Upstream: animate-expo

Canonical copy in this repo: `docs/ai/skills/animate-expo/`, mirrored to
...
- **Source path:** `skills/animate-expo/`
...
- This skill is unused for Core Next.js apps; keep it available only for
  explicit Expo/React Native work.
