...
2. Copy the relevant skill tree from `.agents/skills/setup-matt-pocock-skills/` into `docs/ai/skills/setup-matt-pocock-skills/` if this canonical copy needs updating.
