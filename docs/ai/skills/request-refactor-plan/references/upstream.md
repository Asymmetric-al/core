...
2. Copy the relevant skill tree from `.agents/skills/request-refactor-plan/` into `docs/ai/skills/request-refactor-plan/` if this canonical copy needs updating.
