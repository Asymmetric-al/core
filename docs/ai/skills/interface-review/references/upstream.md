...
source_path: skills/interface-review/
...
Canonical copy in this repo: `docs/ai/skills/interface-review/`, mirrored to
...
- **Source path:** `skills/interface-review/`
...
1. Refresh the lockfile-managed skill with a targeted Skills CLI add:
   `npx skills add jakubkrehel/skills --skill interface-review -y`.
