...
| App source (any)             | Must not import raw Twenty clients from `packages/api/src/crm/client/*` or reference `TWENTY_API_KEY` / `TWENTY_WEBHOOK_SECRET` | same as above                                                                                                                                              | Documented + Repository-enforced                      |
